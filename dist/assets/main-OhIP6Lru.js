var rl=Object.defineProperty;var sl=(r,t,e)=>t in r?rl(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var ye=(r,t,e)=>sl(r,typeof t!="symbol"?t+"":t,e);import"./modulepreload-polyfill-B5Qt9EMX.js";import{W as il}from"./i18n-Ckh14mha.js";import{L as ol,_ as al,C as ul,r as Gi,a as ll,F as cl,b as Mt,g as hl,c as fl,d as dl,e as on,i as Go,p as ml,u as gl,f as pl,h as _l,j as yl,k as El,S as Tl,l as Il,m as vl,G as Al,O as wl,s as Rl,n as Pl,o as Vl}from"./index-36fcbc82-BD-XwMeY.js";var Ki=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Kt,Ko;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(E,m){function p(){}p.prototype=m.prototype,E.F=m.prototype,E.prototype=new p,E.prototype.constructor=E,E.D=function(T,y,A){for(var g=Array(arguments.length-2),Et=2;Et<arguments.length;Et++)g[Et-2]=arguments[Et];return m.prototype[y].apply(T,g)}}function e(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}t(n,e),n.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,m,p){p||(p=0);const T=Array(16);if(typeof m=="string")for(var y=0;y<16;++y)T[y]=m.charCodeAt(p++)|m.charCodeAt(p++)<<8|m.charCodeAt(p++)<<16|m.charCodeAt(p++)<<24;else for(y=0;y<16;++y)T[y]=m[p++]|m[p++]<<8|m[p++]<<16|m[p++]<<24;m=E.g[0],p=E.g[1],y=E.g[2];let A=E.g[3],g;g=m+(A^p&(y^A))+T[0]+3614090360&4294967295,m=p+(g<<7&4294967295|g>>>25),g=A+(y^m&(p^y))+T[1]+3905402710&4294967295,A=m+(g<<12&4294967295|g>>>20),g=y+(p^A&(m^p))+T[2]+606105819&4294967295,y=A+(g<<17&4294967295|g>>>15),g=p+(m^y&(A^m))+T[3]+3250441966&4294967295,p=y+(g<<22&4294967295|g>>>10),g=m+(A^p&(y^A))+T[4]+4118548399&4294967295,m=p+(g<<7&4294967295|g>>>25),g=A+(y^m&(p^y))+T[5]+1200080426&4294967295,A=m+(g<<12&4294967295|g>>>20),g=y+(p^A&(m^p))+T[6]+2821735955&4294967295,y=A+(g<<17&4294967295|g>>>15),g=p+(m^y&(A^m))+T[7]+4249261313&4294967295,p=y+(g<<22&4294967295|g>>>10),g=m+(A^p&(y^A))+T[8]+1770035416&4294967295,m=p+(g<<7&4294967295|g>>>25),g=A+(y^m&(p^y))+T[9]+2336552879&4294967295,A=m+(g<<12&4294967295|g>>>20),g=y+(p^A&(m^p))+T[10]+4294925233&4294967295,y=A+(g<<17&4294967295|g>>>15),g=p+(m^y&(A^m))+T[11]+2304563134&4294967295,p=y+(g<<22&4294967295|g>>>10),g=m+(A^p&(y^A))+T[12]+1804603682&4294967295,m=p+(g<<7&4294967295|g>>>25),g=A+(y^m&(p^y))+T[13]+4254626195&4294967295,A=m+(g<<12&4294967295|g>>>20),g=y+(p^A&(m^p))+T[14]+2792965006&4294967295,y=A+(g<<17&4294967295|g>>>15),g=p+(m^y&(A^m))+T[15]+1236535329&4294967295,p=y+(g<<22&4294967295|g>>>10),g=m+(y^A&(p^y))+T[1]+4129170786&4294967295,m=p+(g<<5&4294967295|g>>>27),g=A+(p^y&(m^p))+T[6]+3225465664&4294967295,A=m+(g<<9&4294967295|g>>>23),g=y+(m^p&(A^m))+T[11]+643717713&4294967295,y=A+(g<<14&4294967295|g>>>18),g=p+(A^m&(y^A))+T[0]+3921069994&4294967295,p=y+(g<<20&4294967295|g>>>12),g=m+(y^A&(p^y))+T[5]+3593408605&4294967295,m=p+(g<<5&4294967295|g>>>27),g=A+(p^y&(m^p))+T[10]+38016083&4294967295,A=m+(g<<9&4294967295|g>>>23),g=y+(m^p&(A^m))+T[15]+3634488961&4294967295,y=A+(g<<14&4294967295|g>>>18),g=p+(A^m&(y^A))+T[4]+3889429448&4294967295,p=y+(g<<20&4294967295|g>>>12),g=m+(y^A&(p^y))+T[9]+568446438&4294967295,m=p+(g<<5&4294967295|g>>>27),g=A+(p^y&(m^p))+T[14]+3275163606&4294967295,A=m+(g<<9&4294967295|g>>>23),g=y+(m^p&(A^m))+T[3]+4107603335&4294967295,y=A+(g<<14&4294967295|g>>>18),g=p+(A^m&(y^A))+T[8]+1163531501&4294967295,p=y+(g<<20&4294967295|g>>>12),g=m+(y^A&(p^y))+T[13]+2850285829&4294967295,m=p+(g<<5&4294967295|g>>>27),g=A+(p^y&(m^p))+T[2]+4243563512&4294967295,A=m+(g<<9&4294967295|g>>>23),g=y+(m^p&(A^m))+T[7]+1735328473&4294967295,y=A+(g<<14&4294967295|g>>>18),g=p+(A^m&(y^A))+T[12]+2368359562&4294967295,p=y+(g<<20&4294967295|g>>>12),g=m+(p^y^A)+T[5]+4294588738&4294967295,m=p+(g<<4&4294967295|g>>>28),g=A+(m^p^y)+T[8]+2272392833&4294967295,A=m+(g<<11&4294967295|g>>>21),g=y+(A^m^p)+T[11]+1839030562&4294967295,y=A+(g<<16&4294967295|g>>>16),g=p+(y^A^m)+T[14]+4259657740&4294967295,p=y+(g<<23&4294967295|g>>>9),g=m+(p^y^A)+T[1]+2763975236&4294967295,m=p+(g<<4&4294967295|g>>>28),g=A+(m^p^y)+T[4]+1272893353&4294967295,A=m+(g<<11&4294967295|g>>>21),g=y+(A^m^p)+T[7]+4139469664&4294967295,y=A+(g<<16&4294967295|g>>>16),g=p+(y^A^m)+T[10]+3200236656&4294967295,p=y+(g<<23&4294967295|g>>>9),g=m+(p^y^A)+T[13]+681279174&4294967295,m=p+(g<<4&4294967295|g>>>28),g=A+(m^p^y)+T[0]+3936430074&4294967295,A=m+(g<<11&4294967295|g>>>21),g=y+(A^m^p)+T[3]+3572445317&4294967295,y=A+(g<<16&4294967295|g>>>16),g=p+(y^A^m)+T[6]+76029189&4294967295,p=y+(g<<23&4294967295|g>>>9),g=m+(p^y^A)+T[9]+3654602809&4294967295,m=p+(g<<4&4294967295|g>>>28),g=A+(m^p^y)+T[12]+3873151461&4294967295,A=m+(g<<11&4294967295|g>>>21),g=y+(A^m^p)+T[15]+530742520&4294967295,y=A+(g<<16&4294967295|g>>>16),g=p+(y^A^m)+T[2]+3299628645&4294967295,p=y+(g<<23&4294967295|g>>>9),g=m+(y^(p|~A))+T[0]+4096336452&4294967295,m=p+(g<<6&4294967295|g>>>26),g=A+(p^(m|~y))+T[7]+1126891415&4294967295,A=m+(g<<10&4294967295|g>>>22),g=y+(m^(A|~p))+T[14]+2878612391&4294967295,y=A+(g<<15&4294967295|g>>>17),g=p+(A^(y|~m))+T[5]+4237533241&4294967295,p=y+(g<<21&4294967295|g>>>11),g=m+(y^(p|~A))+T[12]+1700485571&4294967295,m=p+(g<<6&4294967295|g>>>26),g=A+(p^(m|~y))+T[3]+2399980690&4294967295,A=m+(g<<10&4294967295|g>>>22),g=y+(m^(A|~p))+T[10]+4293915773&4294967295,y=A+(g<<15&4294967295|g>>>17),g=p+(A^(y|~m))+T[1]+2240044497&4294967295,p=y+(g<<21&4294967295|g>>>11),g=m+(y^(p|~A))+T[8]+1873313359&4294967295,m=p+(g<<6&4294967295|g>>>26),g=A+(p^(m|~y))+T[15]+4264355552&4294967295,A=m+(g<<10&4294967295|g>>>22),g=y+(m^(A|~p))+T[6]+2734768916&4294967295,y=A+(g<<15&4294967295|g>>>17),g=p+(A^(y|~m))+T[13]+1309151649&4294967295,p=y+(g<<21&4294967295|g>>>11),g=m+(y^(p|~A))+T[4]+4149444226&4294967295,m=p+(g<<6&4294967295|g>>>26),g=A+(p^(m|~y))+T[11]+3174756917&4294967295,A=m+(g<<10&4294967295|g>>>22),g=y+(m^(A|~p))+T[2]+718787259&4294967295,y=A+(g<<15&4294967295|g>>>17),g=p+(A^(y|~m))+T[9]+3951481745&4294967295,E.g[0]=E.g[0]+m&4294967295,E.g[1]=E.g[1]+(y+(g<<21&4294967295|g>>>11))&4294967295,E.g[2]=E.g[2]+y&4294967295,E.g[3]=E.g[3]+A&4294967295}n.prototype.v=function(E,m){m===void 0&&(m=E.length);const p=m-this.blockSize,T=this.C;let y=this.h,A=0;for(;A<m;){if(y==0)for(;A<=p;)i(this,E,A),A+=this.blockSize;if(typeof E=="string"){for(;A<m;)if(T[y++]=E.charCodeAt(A++),y==this.blockSize){i(this,T),y=0;break}}else for(;A<m;)if(T[y++]=E[A++],y==this.blockSize){i(this,T),y=0;break}}this.h=y,this.o+=m},n.prototype.A=function(){var E=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);E[0]=128;for(var m=1;m<E.length-8;++m)E[m]=0;m=this.o*8;for(var p=E.length-8;p<E.length;++p)E[p]=m&255,m/=256;for(this.v(E),E=Array(16),m=0,p=0;p<4;++p)for(let T=0;T<32;T+=8)E[m++]=this.g[p]>>>T&255;return E};function o(E,m){var p=c;return Object.prototype.hasOwnProperty.call(p,E)?p[E]:p[E]=m(E)}function u(E,m){this.h=m;const p=[];let T=!0;for(let y=E.length-1;y>=0;y--){const A=E[y]|0;T&&A==m||(p[y]=A,T=!1)}this.g=p}var c={};function h(E){return-128<=E&&E<128?o(E,function(m){return new u([m|0],m<0?-1:0)}):new u([E|0],E<0?-1:0)}function d(E){if(isNaN(E)||!isFinite(E))return I;if(E<0)return b(d(-E));const m=[];let p=1;for(let T=0;E>=p;T++)m[T]=E/p|0,p*=4294967296;return new u(m,0)}function _(E,m){if(E.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(E.charAt(0)=="-")return b(_(E.substring(1),m));if(E.indexOf("-")>=0)throw Error('number format error: interior "-" character');const p=d(Math.pow(m,8));let T=I;for(let A=0;A<E.length;A+=8){var y=Math.min(8,E.length-A);const g=parseInt(E.substring(A,A+y),m);y<8?(y=d(Math.pow(m,y)),T=T.j(y).add(d(g))):(T=T.j(p),T=T.add(d(g)))}return T}var I=h(0),P=h(1),S=h(16777216);r=u.prototype,r.m=function(){if(k(this))return-b(this).m();let E=0,m=1;for(let p=0;p<this.g.length;p++){const T=this.i(p);E+=(T>=0?T:4294967296+T)*m,m*=4294967296}return E},r.toString=function(E){if(E=E||10,E<2||36<E)throw Error("radix out of range: "+E);if(M(this))return"0";if(k(this))return"-"+b(this).toString(E);const m=d(Math.pow(E,6));var p=this;let T="";for(;;){const y=ft(p,m).g;p=$(p,y.j(m));let A=((p.g.length>0?p.g[0]:p.h)>>>0).toString(E);if(p=y,M(p))return A+T;for(;A.length<6;)A="0"+A;T=A+T}},r.i=function(E){return E<0?0:E<this.g.length?this.g[E]:this.h};function M(E){if(E.h!=0)return!1;for(let m=0;m<E.g.length;m++)if(E.g[m]!=0)return!1;return!0}function k(E){return E.h==-1}r.l=function(E){return E=$(this,E),k(E)?-1:M(E)?0:1};function b(E){const m=E.g.length,p=[];for(let T=0;T<m;T++)p[T]=~E.g[T];return new u(p,~E.h).add(P)}r.abs=function(){return k(this)?b(this):this},r.add=function(E){const m=Math.max(this.g.length,E.g.length),p=[];let T=0;for(let y=0;y<=m;y++){let A=T+(this.i(y)&65535)+(E.i(y)&65535),g=(A>>>16)+(this.i(y)>>>16)+(E.i(y)>>>16);T=g>>>16,A&=65535,g&=65535,p[y]=g<<16|A}return new u(p,p[p.length-1]&-2147483648?-1:0)};function $(E,m){return E.add(b(m))}r.j=function(E){if(M(this)||M(E))return I;if(k(this))return k(E)?b(this).j(b(E)):b(b(this).j(E));if(k(E))return b(this.j(b(E)));if(this.l(S)<0&&E.l(S)<0)return d(this.m()*E.m());const m=this.g.length+E.g.length,p=[];for(var T=0;T<2*m;T++)p[T]=0;for(T=0;T<this.g.length;T++)for(let y=0;y<E.g.length;y++){const A=this.i(T)>>>16,g=this.i(T)&65535,Et=E.i(y)>>>16,ee=E.i(y)&65535;p[2*T+2*y]+=g*ee,G(p,2*T+2*y),p[2*T+2*y+1]+=A*ee,G(p,2*T+2*y+1),p[2*T+2*y+1]+=g*Et,G(p,2*T+2*y+1),p[2*T+2*y+2]+=A*Et,G(p,2*T+2*y+2)}for(E=0;E<m;E++)p[E]=p[2*E+1]<<16|p[2*E];for(E=m;E<2*m;E++)p[E]=0;return new u(p,0)};function G(E,m){for(;(E[m]&65535)!=E[m];)E[m+1]+=E[m]>>>16,E[m]&=65535,m++}function Q(E,m){this.g=E,this.h=m}function ft(E,m){if(M(m))throw Error("division by zero");if(M(E))return new Q(I,I);if(k(E))return m=ft(b(E),m),new Q(b(m.g),b(m.h));if(k(m))return m=ft(E,b(m)),new Q(b(m.g),m.h);if(E.g.length>30){if(k(E)||k(m))throw Error("slowDivide_ only works with positive integers.");for(var p=P,T=m;T.l(E)<=0;)p=It(p),T=It(T);var y=nt(p,1),A=nt(T,1);for(T=nt(T,2),p=nt(p,2);!M(T);){var g=A.add(T);g.l(E)<=0&&(y=y.add(p),A=g),T=nt(T,1),p=nt(p,1)}return m=$(E,y.j(m)),new Q(y,m)}for(y=I;E.l(m)>=0;){for(p=Math.max(1,Math.floor(E.m()/m.m())),T=Math.ceil(Math.log(p)/Math.LN2),T=T<=48?1:Math.pow(2,T-48),A=d(p),g=A.j(m);k(g)||g.l(E)>0;)p-=T,A=d(p),g=A.j(m);M(A)&&(A=P),y=y.add(A),E=$(E,g)}return new Q(y,E)}r.B=function(E){return ft(this,E).h},r.and=function(E){const m=Math.max(this.g.length,E.g.length),p=[];for(let T=0;T<m;T++)p[T]=this.i(T)&E.i(T);return new u(p,this.h&E.h)},r.or=function(E){const m=Math.max(this.g.length,E.g.length),p=[];for(let T=0;T<m;T++)p[T]=this.i(T)|E.i(T);return new u(p,this.h|E.h)},r.xor=function(E){const m=Math.max(this.g.length,E.g.length),p=[];for(let T=0;T<m;T++)p[T]=this.i(T)^E.i(T);return new u(p,this.h^E.h)};function It(E){const m=E.g.length+1,p=[];for(let T=0;T<m;T++)p[T]=E.i(T)<<1|E.i(T-1)>>>31;return new u(p,E.h)}function nt(E,m){const p=m>>5;m%=32;const T=E.g.length-p,y=[];for(let A=0;A<T;A++)y[A]=m>0?E.i(A+p)>>>m|E.i(A+p+1)<<32-m:E.i(A+p);return new u(y,E.h)}n.prototype.digest=n.prototype.A,n.prototype.reset=n.prototype.u,n.prototype.update=n.prototype.v,Ko=n,u.prototype.add=u.prototype.add,u.prototype.multiply=u.prototype.j,u.prototype.modulo=u.prototype.B,u.prototype.compare=u.prototype.l,u.prototype.toNumber=u.prototype.m,u.prototype.toString=u.prototype.toString,u.prototype.getBits=u.prototype.i,u.fromNumber=d,u.fromString=_,Kt=u}).apply(typeof Ki<"u"?Ki:typeof self<"u"?self:typeof window<"u"?window:{});var On=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Qo,Ye,Wo,Bn,Wr,Ho,Xo,Yo;(function(){var r,t=Object.defineProperty;function e(s){s=[typeof globalThis=="object"&&globalThis,s,typeof window=="object"&&window,typeof self=="object"&&self,typeof On=="object"&&On];for(var a=0;a<s.length;++a){var l=s[a];if(l&&l.Math==Math)return l}throw Error("Cannot find global object")}var n=e(this);function i(s,a){if(a)t:{var l=n;s=s.split(".");for(var f=0;f<s.length-1;f++){var v=s[f];if(!(v in l))break t;l=l[v]}s=s[s.length-1],f=l[s],a=a(f),a!=f&&a!=null&&t(l,s,{configurable:!0,writable:!0,value:a})}}i("Symbol.dispose",function(s){return s||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(s){return s||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(s){return s||function(a){var l=[],f;for(f in a)Object.prototype.hasOwnProperty.call(a,f)&&l.push([f,a[f]]);return l}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},u=this||self;function c(s){var a=typeof s;return a=="object"&&s!=null||a=="function"}function h(s,a,l){return s.call.apply(s.bind,arguments)}function d(s,a,l){return d=h,d.apply(null,arguments)}function _(s,a){var l=Array.prototype.slice.call(arguments,1);return function(){var f=l.slice();return f.push.apply(f,arguments),s.apply(this,f)}}function I(s,a){function l(){}l.prototype=a.prototype,s.Z=a.prototype,s.prototype=new l,s.prototype.constructor=s,s.Ob=function(f,v,w){for(var C=Array(arguments.length-2),U=2;U<arguments.length;U++)C[U-2]=arguments[U];return a.prototype[v].apply(f,C)}}var P=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?s=>s&&AsyncContext.Snapshot.wrap(s):s=>s;function S(s){const a=s.length;if(a>0){const l=Array(a);for(let f=0;f<a;f++)l[f]=s[f];return l}return[]}function M(s,a){for(let f=1;f<arguments.length;f++){const v=arguments[f];var l=typeof v;if(l=l!="object"?l:v?Array.isArray(v)?"array":l:"null",l=="array"||l=="object"&&typeof v.length=="number"){l=s.length||0;const w=v.length||0;s.length=l+w;for(let C=0;C<w;C++)s[l+C]=v[C]}else s.push(v)}}class k{constructor(a,l){this.i=a,this.j=l,this.h=0,this.g=null}get(){let a;return this.h>0?(this.h--,a=this.g,this.g=a.next,a.next=null):a=this.i(),a}}function b(s){u.setTimeout(()=>{throw s},0)}function $(){var s=E;let a=null;return s.g&&(a=s.g,s.g=s.g.next,s.g||(s.h=null),a.next=null),a}class G{constructor(){this.h=this.g=null}add(a,l){const f=Q.get();f.set(a,l),this.h?this.h.next=f:this.g=f,this.h=f}}var Q=new k(()=>new ft,s=>s.reset());class ft{constructor(){this.next=this.g=this.h=null}set(a,l){this.h=a,this.g=l,this.next=null}reset(){this.next=this.g=this.h=null}}let It,nt=!1,E=new G,m=()=>{const s=Promise.resolve(void 0);It=()=>{s.then(p)}};function p(){for(var s;s=$();){try{s.h.call(s.g)}catch(l){b(l)}var a=Q;a.j(s),a.h<100&&(a.h++,s.next=a.g,a.g=s)}nt=!1}function T(){this.u=this.u,this.C=this.C}T.prototype.u=!1,T.prototype.dispose=function(){this.u||(this.u=!0,this.N())},T.prototype[Symbol.dispose]=function(){this.dispose()},T.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function y(s,a){this.type=s,this.g=this.target=a,this.defaultPrevented=!1}y.prototype.h=function(){this.defaultPrevented=!0};var A=function(){if(!u.addEventListener||!Object.defineProperty)return!1;var s=!1,a=Object.defineProperty({},"passive",{get:function(){s=!0}});try{const l=()=>{};u.addEventListener("test",l,a),u.removeEventListener("test",l,a)}catch{}return s}();function g(s){return/^[\s\xa0]*$/.test(s)}function Et(s,a){y.call(this,s?s.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,s&&this.init(s,a)}I(Et,y),Et.prototype.init=function(s,a){const l=this.type=s.type,f=s.changedTouches&&s.changedTouches.length?s.changedTouches[0]:null;this.target=s.target||s.srcElement,this.g=a,a=s.relatedTarget,a||(l=="mouseover"?a=s.fromElement:l=="mouseout"&&(a=s.toElement)),this.relatedTarget=a,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0),this.button=s.button,this.key=s.key||"",this.ctrlKey=s.ctrlKey,this.altKey=s.altKey,this.shiftKey=s.shiftKey,this.metaKey=s.metaKey,this.pointerId=s.pointerId||0,this.pointerType=s.pointerType,this.state=s.state,this.i=s,s.defaultPrevented&&Et.Z.h.call(this)},Et.prototype.h=function(){Et.Z.h.call(this);const s=this.i;s.preventDefault?s.preventDefault():s.returnValue=!1};var ee="closure_listenable_"+(Math.random()*1e6|0),Ru=0;function Pu(s,a,l,f,v){this.listener=s,this.proxy=null,this.src=a,this.type=l,this.capture=!!f,this.ha=v,this.key=++Ru,this.da=this.fa=!1}function In(s){s.da=!0,s.listener=null,s.proxy=null,s.src=null,s.ha=null}function vn(s,a,l){for(const f in s)a.call(l,s[f],f,s)}function Vu(s,a){for(const l in s)a.call(void 0,s[l],l,s)}function $s(s){const a={};for(const l in s)a[l]=s[l];return a}const Gs="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ks(s,a){let l,f;for(let v=1;v<arguments.length;v++){f=arguments[v];for(l in f)s[l]=f[l];for(let w=0;w<Gs.length;w++)l=Gs[w],Object.prototype.hasOwnProperty.call(f,l)&&(s[l]=f[l])}}function An(s){this.src=s,this.g={},this.h=0}An.prototype.add=function(s,a,l,f,v){const w=s.toString();s=this.g[w],s||(s=this.g[w]=[],this.h++);const C=Tr(s,a,f,v);return C>-1?(a=s[C],l||(a.fa=!1)):(a=new Pu(a,this.src,w,!!f,v),a.fa=l,s.push(a)),a};function Er(s,a){const l=a.type;if(l in s.g){var f=s.g[l],v=Array.prototype.indexOf.call(f,a,void 0),w;(w=v>=0)&&Array.prototype.splice.call(f,v,1),w&&(In(a),s.g[l].length==0&&(delete s.g[l],s.h--))}}function Tr(s,a,l,f){for(let v=0;v<s.length;++v){const w=s[v];if(!w.da&&w.listener==a&&w.capture==!!l&&w.ha==f)return v}return-1}var Ir="closure_lm_"+(Math.random()*1e6|0),vr={};function Qs(s,a,l,f,v){if(Array.isArray(a)){for(let w=0;w<a.length;w++)Qs(s,a[w],l,f,v);return null}return l=Xs(l),s&&s[ee]?s.J(a,l,c(f)?!!f.capture:!1,v):Su(s,a,l,!1,f,v)}function Su(s,a,l,f,v,w){if(!a)throw Error("Invalid event type");const C=c(v)?!!v.capture:!!v;let U=wr(s);if(U||(s[Ir]=U=new An(s)),l=U.add(a,l,f,C,w),l.proxy)return l;if(f=Cu(),l.proxy=f,f.src=s,f.listener=l,s.addEventListener)A||(v=C),v===void 0&&(v=!1),s.addEventListener(a.toString(),f,v);else if(s.attachEvent)s.attachEvent(Hs(a.toString()),f);else if(s.addListener&&s.removeListener)s.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return l}function Cu(){function s(l){return a.call(s.src,s.listener,l)}const a=bu;return s}function Ws(s,a,l,f,v){if(Array.isArray(a))for(var w=0;w<a.length;w++)Ws(s,a[w],l,f,v);else f=c(f)?!!f.capture:!!f,l=Xs(l),s&&s[ee]?(s=s.i,w=String(a).toString(),w in s.g&&(a=s.g[w],l=Tr(a,l,f,v),l>-1&&(In(a[l]),Array.prototype.splice.call(a,l,1),a.length==0&&(delete s.g[w],s.h--)))):s&&(s=wr(s))&&(a=s.g[a.toString()],s=-1,a&&(s=Tr(a,l,f,v)),(l=s>-1?a[s]:null)&&Ar(l))}function Ar(s){if(typeof s!="number"&&s&&!s.da){var a=s.src;if(a&&a[ee])Er(a.i,s);else{var l=s.type,f=s.proxy;a.removeEventListener?a.removeEventListener(l,f,s.capture):a.detachEvent?a.detachEvent(Hs(l),f):a.addListener&&a.removeListener&&a.removeListener(f),(l=wr(a))?(Er(l,s),l.h==0&&(l.src=null,a[Ir]=null)):In(s)}}}function Hs(s){return s in vr?vr[s]:vr[s]="on"+s}function bu(s,a){if(s.da)s=!0;else{a=new Et(a,this);const l=s.listener,f=s.ha||s.src;s.fa&&Ar(s),s=l.call(f,a)}return s}function wr(s){return s=s[Ir],s instanceof An?s:null}var Rr="__closure_events_fn_"+(Math.random()*1e9>>>0);function Xs(s){return typeof s=="function"?s:(s[Rr]||(s[Rr]=function(a){return s.handleEvent(a)}),s[Rr])}function dt(){T.call(this),this.i=new An(this),this.M=this,this.G=null}I(dt,T),dt.prototype[ee]=!0,dt.prototype.removeEventListener=function(s,a,l,f){Ws(this,s,a,l,f)};function _t(s,a){var l,f=s.G;if(f)for(l=[];f;f=f.G)l.push(f);if(s=s.M,f=a.type||a,typeof a=="string")a=new y(a,s);else if(a instanceof y)a.target=a.target||s;else{var v=a;a=new y(f,s),Ks(a,v)}v=!0;let w,C;if(l)for(C=l.length-1;C>=0;C--)w=a.g=l[C],v=wn(w,f,!0,a)&&v;if(w=a.g=s,v=wn(w,f,!0,a)&&v,v=wn(w,f,!1,a)&&v,l)for(C=0;C<l.length;C++)w=a.g=l[C],v=wn(w,f,!1,a)&&v}dt.prototype.N=function(){if(dt.Z.N.call(this),this.i){var s=this.i;for(const a in s.g){const l=s.g[a];for(let f=0;f<l.length;f++)In(l[f]);delete s.g[a],s.h--}}this.G=null},dt.prototype.J=function(s,a,l,f){return this.i.add(String(s),a,!1,l,f)},dt.prototype.K=function(s,a,l,f){return this.i.add(String(s),a,!0,l,f)};function wn(s,a,l,f){if(a=s.i.g[String(a)],!a)return!0;a=a.concat();let v=!0;for(let w=0;w<a.length;++w){const C=a[w];if(C&&!C.da&&C.capture==l){const U=C.listener,rt=C.ha||C.src;C.fa&&Er(s.i,C),v=U.call(rt,f)!==!1&&v}}return v&&!f.defaultPrevented}function Du(s,a){if(typeof s!="function")if(s&&typeof s.handleEvent=="function")s=d(s.handleEvent,s);else throw Error("Invalid listener argument");return Number(a)>2147483647?-1:u.setTimeout(s,a||0)}function Ys(s){s.g=Du(()=>{s.g=null,s.i&&(s.i=!1,Ys(s))},s.l);const a=s.h;s.h=null,s.m.apply(null,a)}class Nu extends T{constructor(a,l){super(),this.m=a,this.l=l,this.h=null,this.i=!1,this.g=null}j(a){this.h=arguments,this.g?this.i=!0:Ys(this)}N(){super.N(),this.g&&(u.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Me(s){T.call(this),this.h=s,this.g={}}I(Me,T);var Js=[];function Zs(s){vn(s.g,function(a,l){this.g.hasOwnProperty(l)&&Ar(a)},s),s.g={}}Me.prototype.N=function(){Me.Z.N.call(this),Zs(this)},Me.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Pr=u.JSON.stringify,ku=u.JSON.parse,xu=class{stringify(s){return u.JSON.stringify(s,void 0)}parse(s){return u.JSON.parse(s,void 0)}};function ti(){}function ei(){}var Oe={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Vr(){y.call(this,"d")}I(Vr,y);function Sr(){y.call(this,"c")}I(Sr,y);var ne={},ni=null;function Rn(){return ni=ni||new dt}ne.Ia="serverreachability";function ri(s){y.call(this,ne.Ia,s)}I(ri,y);function Le(s){const a=Rn();_t(a,new ri(a))}ne.STAT_EVENT="statevent";function si(s,a){y.call(this,ne.STAT_EVENT,s),this.stat=a}I(si,y);function yt(s){const a=Rn();_t(a,new si(a,s))}ne.Ja="timingevent";function ii(s,a){y.call(this,ne.Ja,s),this.size=a}I(ii,y);function Fe(s,a){if(typeof s!="function")throw Error("Fn must not be null and must be a function");return u.setTimeout(function(){s()},a)}function Ue(){this.g=!0}Ue.prototype.ua=function(){this.g=!1};function Mu(s,a,l,f,v,w){s.info(function(){if(s.g)if(w){var C="",U=w.split("&");for(let K=0;K<U.length;K++){var rt=U[K].split("=");if(rt.length>1){const at=rt[0];rt=rt[1];const Vt=at.split("_");C=Vt.length>=2&&Vt[1]=="type"?C+(at+"="+rt+"&"):C+(at+"=redacted&")}}}else C=null;else C=w;return"XMLHTTP REQ ("+f+") [attempt "+v+"]: "+a+`
`+l+`
`+C})}function Ou(s,a,l,f,v,w,C){s.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+v+"]: "+a+`
`+l+`
`+w+" "+C})}function ge(s,a,l,f){s.info(function(){return"XMLHTTP TEXT ("+a+"): "+Fu(s,l)+(f?" "+f:"")})}function Lu(s,a){s.info(function(){return"TIMEOUT: "+a})}Ue.prototype.info=function(){};function Fu(s,a){if(!s.g)return a;if(!a)return null;try{const w=JSON.parse(a);if(w){for(s=0;s<w.length;s++)if(Array.isArray(w[s])){var l=w[s];if(!(l.length<2)){var f=l[1];if(Array.isArray(f)&&!(f.length<1)){var v=f[0];if(v!="noop"&&v!="stop"&&v!="close")for(let C=1;C<f.length;C++)f[C]=""}}}}return Pr(w)}catch{return a}}var Pn={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},oi={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},ai;function Cr(){}I(Cr,ti),Cr.prototype.g=function(){return new XMLHttpRequest},ai=new Cr;function qe(s){return encodeURIComponent(String(s))}function Uu(s){var a=1;s=s.split(":");const l=[];for(;a>0&&s.length;)l.push(s.shift()),a--;return s.length&&l.push(s.join(":")),l}function Ut(s,a,l,f){this.j=s,this.i=a,this.l=l,this.S=f||1,this.V=new Me(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new ui}function ui(){this.i=null,this.g="",this.h=!1}var li={},br={};function Dr(s,a,l){s.M=1,s.A=Sn(Pt(a)),s.u=l,s.R=!0,ci(s,null)}function ci(s,a){s.F=Date.now(),Vn(s),s.B=Pt(s.A);var l=s.B,f=s.S;Array.isArray(f)||(f=[String(f)]),Ai(l.i,"t",f),s.C=0,l=s.j.L,s.h=new ui,s.g=ji(s.j,l?a:null,!s.u),s.P>0&&(s.O=new Nu(d(s.Y,s,s.g),s.P)),a=s.V,l=s.g,f=s.ba;var v="readystatechange";Array.isArray(v)||(v&&(Js[0]=v.toString()),v=Js);for(let w=0;w<v.length;w++){const C=Qs(l,v[w],f||a.handleEvent,!1,a.h||a);if(!C)break;a.g[C.key]=C}a=s.J?$s(s.J):{},s.u?(s.v||(s.v="POST"),a["Content-Type"]="application/x-www-form-urlencoded",s.g.ea(s.B,s.v,s.u,a)):(s.v="GET",s.g.ea(s.B,s.v,null,a)),Le(),Mu(s.i,s.v,s.B,s.l,s.S,s.u)}Ut.prototype.ba=function(s){s=s.target;const a=this.O;a&&Bt(s)==3?a.j():this.Y(s)},Ut.prototype.Y=function(s){try{if(s==this.g)t:{const U=Bt(this.g),rt=this.g.ya(),K=this.g.ca();if(!(U<3)&&(U!=3||this.g&&(this.h.h||this.g.la()||bi(this.g)))){this.K||U!=4||rt==7||(rt==8||K<=0?Le(3):Le(2)),Nr(this);var a=this.g.ca();this.X=a;var l=qu(this);if(this.o=a==200,Ou(this.i,this.v,this.B,this.l,this.S,U,a),this.o){if(this.U&&!this.L){e:{if(this.g){var f,v=this.g;if((f=v.g?v.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(f)){var w=f;break e}}w=null}if(s=w)ge(this.i,this.l,s,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,kr(this,s);else{this.o=!1,this.m=3,yt(12),re(this),je(this);break t}}if(this.R){s=!0;let at;for(;!this.K&&this.C<l.length;)if(at=ju(this,l),at==br){U==4&&(this.m=4,yt(14),s=!1),ge(this.i,this.l,null,"[Incomplete Response]");break}else if(at==li){this.m=4,yt(15),ge(this.i,this.l,l,"[Invalid Chunk]"),s=!1;break}else ge(this.i,this.l,at,null),kr(this,at);if(hi(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),U!=4||l.length!=0||this.h.h||(this.m=1,yt(16),s=!1),this.o=this.o&&s,!s)ge(this.i,this.l,l,"[Invalid Chunked Response]"),re(this),je(this);else if(l.length>0&&!this.W){this.W=!0;var C=this.j;C.g==this&&C.aa&&!C.P&&(C.j.info("Great, no buffering proxy detected. Bytes received: "+l.length),jr(C),C.P=!0,yt(11))}}else ge(this.i,this.l,l,null),kr(this,l);U==4&&re(this),this.o&&!this.K&&(U==4?Li(this.j,this):(this.o=!1,Vn(this)))}else el(this.g),a==400&&l.indexOf("Unknown SID")>0?(this.m=3,yt(12)):(this.m=0,yt(13)),re(this),je(this)}}}catch{}finally{}};function qu(s){if(!hi(s))return s.g.la();const a=bi(s.g);if(a==="")return"";let l="";const f=a.length,v=Bt(s.g)==4;if(!s.h.i){if(typeof TextDecoder>"u")return re(s),je(s),"";s.h.i=new u.TextDecoder}for(let w=0;w<f;w++)s.h.h=!0,l+=s.h.i.decode(a[w],{stream:!(v&&w==f-1)});return a.length=0,s.h.g+=l,s.C=0,s.h.g}function hi(s){return s.g?s.v=="GET"&&s.M!=2&&s.j.Aa:!1}function ju(s,a){var l=s.C,f=a.indexOf(`
`,l);return f==-1?br:(l=Number(a.substring(l,f)),isNaN(l)?li:(f+=1,f+l>a.length?br:(a=a.slice(f,f+l),s.C=f+l,a)))}Ut.prototype.cancel=function(){this.K=!0,re(this)};function Vn(s){s.T=Date.now()+s.H,fi(s,s.H)}function fi(s,a){if(s.D!=null)throw Error("WatchDog timer not null");s.D=Fe(d(s.aa,s),a)}function Nr(s){s.D&&(u.clearTimeout(s.D),s.D=null)}Ut.prototype.aa=function(){this.D=null;const s=Date.now();s-this.T>=0?(Lu(this.i,this.B),this.M!=2&&(Le(),yt(17)),re(this),this.m=2,je(this)):fi(this,this.T-s)};function je(s){s.j.I==0||s.K||Li(s.j,s)}function re(s){Nr(s);var a=s.O;a&&typeof a.dispose=="function"&&a.dispose(),s.O=null,Zs(s.V),s.g&&(a=s.g,s.g=null,a.abort(),a.dispose())}function kr(s,a){try{var l=s.j;if(l.I!=0&&(l.g==s||xr(l.h,s))){if(!s.L&&xr(l.h,s)&&l.I==3){try{var f=l.Ba.g.parse(a)}catch{f=null}if(Array.isArray(f)&&f.length==3){var v=f;if(v[0]==0){t:if(!l.v){if(l.g)if(l.g.F+3e3<s.F)kn(l),Dn(l);else break t;qr(l),yt(18)}}else l.xa=v[1],0<l.xa-l.K&&v[2]<37500&&l.F&&l.A==0&&!l.C&&(l.C=Fe(d(l.Va,l),6e3));gi(l.h)<=1&&l.ta&&(l.ta=void 0)}else ie(l,11)}else if((s.L||l.g==s)&&kn(l),!g(a))for(v=l.Ba.g.parse(a),a=0;a<v.length;a++){let K=v[a];const at=K[0];if(!(at<=l.K))if(l.K=at,K=K[1],l.I==2)if(K[0]=="c"){l.M=K[1],l.ba=K[2];const Vt=K[3];Vt!=null&&(l.ka=Vt,l.j.info("VER="+l.ka));const oe=K[4];oe!=null&&(l.za=oe,l.j.info("SVER="+l.za));const zt=K[5];zt!=null&&typeof zt=="number"&&zt>0&&(f=1.5*zt,l.O=f,l.j.info("backChannelRequestTimeoutMs_="+f)),f=l;const $t=s.g;if($t){const Mn=$t.g?$t.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Mn){var w=f.h;w.g||Mn.indexOf("spdy")==-1&&Mn.indexOf("quic")==-1&&Mn.indexOf("h2")==-1||(w.j=w.l,w.g=new Set,w.h&&(Mr(w,w.h),w.h=null))}if(f.G){const Br=$t.g?$t.g.getResponseHeader("X-HTTP-Session-Id"):null;Br&&(f.wa=Br,W(f.J,f.G,Br))}}l.I=3,l.l&&l.l.ra(),l.aa&&(l.T=Date.now()-s.F,l.j.info("Handshake RTT: "+l.T+"ms")),f=l;var C=s;if(f.na=qi(f,f.L?f.ba:null,f.W),C.L){pi(f.h,C);var U=C,rt=f.O;rt&&(U.H=rt),U.D&&(Nr(U),Vn(U)),f.g=C}else Mi(f);l.i.length>0&&Nn(l)}else K[0]!="stop"&&K[0]!="close"||ie(l,7);else l.I==3&&(K[0]=="stop"||K[0]=="close"?K[0]=="stop"?ie(l,7):Ur(l):K[0]!="noop"&&l.l&&l.l.qa(K),l.A=0)}}Le(4)}catch{}}var Bu=class{constructor(s,a){this.g=s,this.map=a}};function di(s){this.l=s||10,u.PerformanceNavigationTiming?(s=u.performance.getEntriesByType("navigation"),s=s.length>0&&(s[0].nextHopProtocol=="hq"||s[0].nextHopProtocol=="h2")):s=!!(u.chrome&&u.chrome.loadTimes&&u.chrome.loadTimes()&&u.chrome.loadTimes().wasFetchedViaSpdy),this.j=s?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function mi(s){return s.h?!0:s.g?s.g.size>=s.j:!1}function gi(s){return s.h?1:s.g?s.g.size:0}function xr(s,a){return s.h?s.h==a:s.g?s.g.has(a):!1}function Mr(s,a){s.g?s.g.add(a):s.h=a}function pi(s,a){s.h&&s.h==a?s.h=null:s.g&&s.g.has(a)&&s.g.delete(a)}di.prototype.cancel=function(){if(this.i=_i(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const s of this.g.values())s.cancel();this.g.clear()}};function _i(s){if(s.h!=null)return s.i.concat(s.h.G);if(s.g!=null&&s.g.size!==0){let a=s.i;for(const l of s.g.values())a=a.concat(l.G);return a}return S(s.i)}var yi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function zu(s,a){if(s){s=s.split("&");for(let l=0;l<s.length;l++){const f=s[l].indexOf("=");let v,w=null;f>=0?(v=s[l].substring(0,f),w=s[l].substring(f+1)):v=s[l],a(v,w?decodeURIComponent(w.replace(/\+/g," ")):"")}}}function qt(s){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let a;s instanceof qt?(this.l=s.l,Be(this,s.j),this.o=s.o,this.g=s.g,ze(this,s.u),this.h=s.h,Or(this,wi(s.i)),this.m=s.m):s&&(a=String(s).match(yi))?(this.l=!1,Be(this,a[1]||"",!0),this.o=$e(a[2]||""),this.g=$e(a[3]||"",!0),ze(this,a[4]),this.h=$e(a[5]||"",!0),Or(this,a[6]||"",!0),this.m=$e(a[7]||"")):(this.l=!1,this.i=new Ke(null,this.l))}qt.prototype.toString=function(){const s=[];var a=this.j;a&&s.push(Ge(a,Ei,!0),":");var l=this.g;return(l||a=="file")&&(s.push("//"),(a=this.o)&&s.push(Ge(a,Ei,!0),"@"),s.push(qe(l).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l=this.u,l!=null&&s.push(":",String(l))),(l=this.h)&&(this.g&&l.charAt(0)!="/"&&s.push("/"),s.push(Ge(l,l.charAt(0)=="/"?Ku:Gu,!0))),(l=this.i.toString())&&s.push("?",l),(l=this.m)&&s.push("#",Ge(l,Wu)),s.join("")},qt.prototype.resolve=function(s){const a=Pt(this);let l=!!s.j;l?Be(a,s.j):l=!!s.o,l?a.o=s.o:l=!!s.g,l?a.g=s.g:l=s.u!=null;var f=s.h;if(l)ze(a,s.u);else if(l=!!s.h){if(f.charAt(0)!="/")if(this.g&&!this.h)f="/"+f;else{var v=a.h.lastIndexOf("/");v!=-1&&(f=a.h.slice(0,v+1)+f)}if(v=f,v==".."||v==".")f="";else if(v.indexOf("./")!=-1||v.indexOf("/.")!=-1){f=v.lastIndexOf("/",0)==0,v=v.split("/");const w=[];for(let C=0;C<v.length;){const U=v[C++];U=="."?f&&C==v.length&&w.push(""):U==".."?((w.length>1||w.length==1&&w[0]!="")&&w.pop(),f&&C==v.length&&w.push("")):(w.push(U),f=!0)}f=w.join("/")}else f=v}return l?a.h=f:l=s.i.toString()!=="",l?Or(a,wi(s.i)):l=!!s.m,l&&(a.m=s.m),a};function Pt(s){return new qt(s)}function Be(s,a,l){s.j=l?$e(a,!0):a,s.j&&(s.j=s.j.replace(/:$/,""))}function ze(s,a){if(a){if(a=Number(a),isNaN(a)||a<0)throw Error("Bad port number "+a);s.u=a}else s.u=null}function Or(s,a,l){a instanceof Ke?(s.i=a,Hu(s.i,s.l)):(l||(a=Ge(a,Qu)),s.i=new Ke(a,s.l))}function W(s,a,l){s.i.set(a,l)}function Sn(s){return W(s,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),s}function $e(s,a){return s?a?decodeURI(s.replace(/%25/g,"%2525")):decodeURIComponent(s):""}function Ge(s,a,l){return typeof s=="string"?(s=encodeURI(s).replace(a,$u),l&&(s=s.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),s):null}function $u(s){return s=s.charCodeAt(0),"%"+(s>>4&15).toString(16)+(s&15).toString(16)}var Ei=/[#\/\?@]/g,Gu=/[#\?:]/g,Ku=/[#\?]/g,Qu=/[#\?@]/g,Wu=/#/g;function Ke(s,a){this.h=this.g=null,this.i=s||null,this.j=!!a}function se(s){s.g||(s.g=new Map,s.h=0,s.i&&zu(s.i,function(a,l){s.add(decodeURIComponent(a.replace(/\+/g," ")),l)}))}r=Ke.prototype,r.add=function(s,a){se(this),this.i=null,s=pe(this,s);let l=this.g.get(s);return l||this.g.set(s,l=[]),l.push(a),this.h+=1,this};function Ti(s,a){se(s),a=pe(s,a),s.g.has(a)&&(s.i=null,s.h-=s.g.get(a).length,s.g.delete(a))}function Ii(s,a){return se(s),a=pe(s,a),s.g.has(a)}r.forEach=function(s,a){se(this),this.g.forEach(function(l,f){l.forEach(function(v){s.call(a,v,f,this)},this)},this)};function vi(s,a){se(s);let l=[];if(typeof a=="string")Ii(s,a)&&(l=l.concat(s.g.get(pe(s,a))));else for(s=Array.from(s.g.values()),a=0;a<s.length;a++)l=l.concat(s[a]);return l}r.set=function(s,a){return se(this),this.i=null,s=pe(this,s),Ii(this,s)&&(this.h-=this.g.get(s).length),this.g.set(s,[a]),this.h+=1,this},r.get=function(s,a){return s?(s=vi(this,s),s.length>0?String(s[0]):a):a};function Ai(s,a,l){Ti(s,a),l.length>0&&(s.i=null,s.g.set(pe(s,a),S(l)),s.h+=l.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const s=[],a=Array.from(this.g.keys());for(let f=0;f<a.length;f++){var l=a[f];const v=qe(l);l=vi(this,l);for(let w=0;w<l.length;w++){let C=v;l[w]!==""&&(C+="="+qe(l[w])),s.push(C)}}return this.i=s.join("&")};function wi(s){const a=new Ke;return a.i=s.i,s.g&&(a.g=new Map(s.g),a.h=s.h),a}function pe(s,a){return a=String(a),s.j&&(a=a.toLowerCase()),a}function Hu(s,a){a&&!s.j&&(se(s),s.i=null,s.g.forEach(function(l,f){const v=f.toLowerCase();f!=v&&(Ti(this,f),Ai(this,v,l))},s)),s.j=a}function Xu(s,a){const l=new Ue;if(u.Image){const f=new Image;f.onload=_(jt,l,"TestLoadImage: loaded",!0,a,f),f.onerror=_(jt,l,"TestLoadImage: error",!1,a,f),f.onabort=_(jt,l,"TestLoadImage: abort",!1,a,f),f.ontimeout=_(jt,l,"TestLoadImage: timeout",!1,a,f),u.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=s}else a(!1)}function Yu(s,a){const l=new Ue,f=new AbortController,v=setTimeout(()=>{f.abort(),jt(l,"TestPingServer: timeout",!1,a)},1e4);fetch(s,{signal:f.signal}).then(w=>{clearTimeout(v),w.ok?jt(l,"TestPingServer: ok",!0,a):jt(l,"TestPingServer: server error",!1,a)}).catch(()=>{clearTimeout(v),jt(l,"TestPingServer: error",!1,a)})}function jt(s,a,l,f,v){try{v&&(v.onload=null,v.onerror=null,v.onabort=null,v.ontimeout=null),f(l)}catch{}}function Ju(){this.g=new xu}function Lr(s){this.i=s.Sb||null,this.h=s.ab||!1}I(Lr,ti),Lr.prototype.g=function(){return new Cn(this.i,this.h)};function Cn(s,a){dt.call(this),this.H=s,this.o=a,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}I(Cn,dt),r=Cn.prototype,r.open=function(s,a){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=s,this.D=a,this.readyState=1,We(this)},r.send=function(s){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const a={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};s&&(a.body=s),(this.H||u).fetch(new Request(this.D,a)).then(this.Pa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Qe(this)),this.readyState=0},r.Pa=function(s){if(this.g&&(this.l=s,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=s.headers,this.readyState=2,We(this)),this.g&&(this.readyState=3,We(this),this.g)))if(this.responseType==="arraybuffer")s.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof u.ReadableStream<"u"&&"body"in s){if(this.j=s.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Ri(this)}else s.text().then(this.Oa.bind(this),this.ga.bind(this))};function Ri(s){s.j.read().then(s.Ma.bind(s)).catch(s.ga.bind(s))}r.Ma=function(s){if(this.g){if(this.o&&s.value)this.response.push(s.value);else if(!this.o){var a=s.value?s.value:new Uint8Array(0);(a=this.B.decode(a,{stream:!s.done}))&&(this.response=this.responseText+=a)}s.done?Qe(this):We(this),this.readyState==3&&Ri(this)}},r.Oa=function(s){this.g&&(this.response=this.responseText=s,Qe(this))},r.Na=function(s){this.g&&(this.response=s,Qe(this))},r.ga=function(){this.g&&Qe(this)};function Qe(s){s.readyState=4,s.l=null,s.j=null,s.B=null,We(s)}r.setRequestHeader=function(s,a){this.A.append(s,a)},r.getResponseHeader=function(s){return this.h&&this.h.get(s.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const s=[],a=this.h.entries();for(var l=a.next();!l.done;)l=l.value,s.push(l[0]+": "+l[1]),l=a.next();return s.join(`\r
`)};function We(s){s.onreadystatechange&&s.onreadystatechange.call(s)}Object.defineProperty(Cn.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(s){this.m=s?"include":"same-origin"}});function Pi(s){let a="";return vn(s,function(l,f){a+=f,a+=":",a+=l,a+=`\r
`}),a}function Fr(s,a,l){t:{for(f in l){var f=!1;break t}f=!0}f||(l=Pi(l),typeof s=="string"?l!=null&&qe(l):W(s,a,l))}function J(s){dt.call(this),this.headers=new Map,this.L=s||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}I(J,dt);var Zu=/^https?$/i,tl=["POST","PUT"];r=J.prototype,r.Fa=function(s){this.H=s},r.ea=function(s,a,l,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+s);a=a?a.toUpperCase():"GET",this.D=s,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():ai.g(),this.g.onreadystatechange=P(d(this.Ca,this));try{this.B=!0,this.g.open(a,String(s),!0),this.B=!1}catch(w){Vi(this,w);return}if(s=l||"",l=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var v in f)l.set(v,f[v]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const w of f.keys())l.set(w,f.get(w));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(l.keys()).find(w=>w.toLowerCase()=="content-type"),v=u.FormData&&s instanceof u.FormData,!(Array.prototype.indexOf.call(tl,a,void 0)>=0)||f||v||l.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[w,C]of l)this.g.setRequestHeader(w,C);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(s),this.v=!1}catch(w){Vi(this,w)}};function Vi(s,a){s.h=!1,s.g&&(s.j=!0,s.g.abort(),s.j=!1),s.l=a,s.o=5,Si(s),bn(s)}function Si(s){s.A||(s.A=!0,_t(s,"complete"),_t(s,"error"))}r.abort=function(s){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=s||7,_t(this,"complete"),_t(this,"abort"),bn(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),bn(this,!0)),J.Z.N.call(this)},r.Ca=function(){this.u||(this.B||this.v||this.j?Ci(this):this.Xa())},r.Xa=function(){Ci(this)};function Ci(s){if(s.h&&typeof o<"u"){if(s.v&&Bt(s)==4)setTimeout(s.Ca.bind(s),0);else if(_t(s,"readystatechange"),Bt(s)==4){s.h=!1;try{const w=s.ca();t:switch(w){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var a=!0;break t;default:a=!1}var l;if(!(l=a)){var f;if(f=w===0){let C=String(s.D).match(yi)[1]||null;!C&&u.self&&u.self.location&&(C=u.self.location.protocol.slice(0,-1)),f=!Zu.test(C?C.toLowerCase():"")}l=f}if(l)_t(s,"complete"),_t(s,"success");else{s.o=6;try{var v=Bt(s)>2?s.g.statusText:""}catch{v=""}s.l=v+" ["+s.ca()+"]",Si(s)}}finally{bn(s)}}}}function bn(s,a){if(s.g){s.m&&(clearTimeout(s.m),s.m=null);const l=s.g;s.g=null,a||_t(s,"ready");try{l.onreadystatechange=null}catch{}}}r.isActive=function(){return!!this.g};function Bt(s){return s.g?s.g.readyState:0}r.ca=function(){try{return Bt(this)>2?this.g.status:-1}catch{return-1}},r.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.La=function(s){if(this.g){var a=this.g.responseText;return s&&a.indexOf(s)==0&&(a=a.substring(s.length)),ku(a)}};function bi(s){try{if(!s.g)return null;if("response"in s.g)return s.g.response;switch(s.F){case"":case"text":return s.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in s.g)return s.g.mozResponseArrayBuffer}return null}catch{return null}}function el(s){const a={};s=(s.g&&Bt(s)>=2&&s.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<s.length;f++){if(g(s[f]))continue;var l=Uu(s[f]);const v=l[0];if(l=l[1],typeof l!="string")continue;l=l.trim();const w=a[v]||[];a[v]=w,w.push(l)}Vu(a,function(f){return f.join(", ")})}r.ya=function(){return this.o},r.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function He(s,a,l){return l&&l.internalChannelParams&&l.internalChannelParams[s]||a}function Di(s){this.za=0,this.i=[],this.j=new Ue,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=He("failFast",!1,s),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=He("baseRetryDelayMs",5e3,s),this.Za=He("retryDelaySeedMs",1e4,s),this.Ta=He("forwardChannelMaxRetries",2,s),this.va=He("forwardChannelRequestTimeoutMs",2e4,s),this.ma=s&&s.xmlHttpFactory||void 0,this.Ua=s&&s.Rb||void 0,this.Aa=s&&s.useFetchStreams||!1,this.O=void 0,this.L=s&&s.supportsCrossDomainXhr||!1,this.M="",this.h=new di(s&&s.concurrentRequestLimit),this.Ba=new Ju,this.S=s&&s.fastHandshake||!1,this.R=s&&s.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=s&&s.Pb||!1,s&&s.ua&&this.j.ua(),s&&s.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&s&&s.detectBufferingProxy||!1,this.ia=void 0,s&&s.longPollingTimeout&&s.longPollingTimeout>0&&(this.ia=s.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}r=Di.prototype,r.ka=8,r.I=1,r.connect=function(s,a,l,f){yt(0),this.W=s,this.H=a||{},l&&f!==void 0&&(this.H.OSID=l,this.H.OAID=f),this.F=this.X,this.J=qi(this,null,this.W),Nn(this)};function Ur(s){if(Ni(s),s.I==3){var a=s.V++,l=Pt(s.J);if(W(l,"SID",s.M),W(l,"RID",a),W(l,"TYPE","terminate"),Xe(s,l),a=new Ut(s,s.j,a),a.M=2,a.A=Sn(Pt(l)),l=!1,u.navigator&&u.navigator.sendBeacon)try{l=u.navigator.sendBeacon(a.A.toString(),"")}catch{}!l&&u.Image&&(new Image().src=a.A,l=!0),l||(a.g=ji(a.j,null),a.g.ea(a.A)),a.F=Date.now(),Vn(a)}Ui(s)}function Dn(s){s.g&&(jr(s),s.g.cancel(),s.g=null)}function Ni(s){Dn(s),s.v&&(u.clearTimeout(s.v),s.v=null),kn(s),s.h.cancel(),s.m&&(typeof s.m=="number"&&u.clearTimeout(s.m),s.m=null)}function Nn(s){if(!mi(s.h)&&!s.m){s.m=!0;var a=s.Ea;It||m(),nt||(It(),nt=!0),E.add(a,s),s.D=0}}function nl(s,a){return gi(s.h)>=s.h.j-(s.m?1:0)?!1:s.m?(s.i=a.G.concat(s.i),!0):s.I==1||s.I==2||s.D>=(s.Sa?0:s.Ta)?!1:(s.m=Fe(d(s.Ea,s,a),Fi(s,s.D)),s.D++,!0)}r.Ea=function(s){if(this.m)if(this.m=null,this.I==1){if(!s){this.V=Math.floor(Math.random()*1e5),s=this.V++;const v=new Ut(this,this.j,s);let w=this.o;if(this.U&&(w?(w=$s(w),Ks(w,this.U)):w=this.U),this.u!==null||this.R||(v.J=w,w=null),this.S)t:{for(var a=0,l=0;l<this.i.length;l++){e:{var f=this.i[l];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break e}f=void 0}if(f===void 0)break;if(a+=f,a>4096){a=l;break t}if(a===4096||l===this.i.length-1){a=l+1;break t}}a=1e3}else a=1e3;a=xi(this,v,a),l=Pt(this.J),W(l,"RID",s),W(l,"CVER",22),this.G&&W(l,"X-HTTP-Session-Id",this.G),Xe(this,l),w&&(this.R?a="headers="+qe(Pi(w))+"&"+a:this.u&&Fr(l,this.u,w)),Mr(this.h,v),this.Ra&&W(l,"TYPE","init"),this.S?(W(l,"$req",a),W(l,"SID","null"),v.U=!0,Dr(v,l,null)):Dr(v,l,a),this.I=2}}else this.I==3&&(s?ki(this,s):this.i.length==0||mi(this.h)||ki(this))};function ki(s,a){var l;a?l=a.l:l=s.V++;const f=Pt(s.J);W(f,"SID",s.M),W(f,"RID",l),W(f,"AID",s.K),Xe(s,f),s.u&&s.o&&Fr(f,s.u,s.o),l=new Ut(s,s.j,l,s.D+1),s.u===null&&(l.J=s.o),a&&(s.i=a.G.concat(s.i)),a=xi(s,l,1e3),l.H=Math.round(s.va*.5)+Math.round(s.va*.5*Math.random()),Mr(s.h,l),Dr(l,f,a)}function Xe(s,a){s.H&&vn(s.H,function(l,f){W(a,f,l)}),s.l&&vn({},function(l,f){W(a,f,l)})}function xi(s,a,l){l=Math.min(s.i.length,l);const f=s.l?d(s.l.Ka,s.l,s):null;t:{var v=s.i;let U=-1;for(;;){const rt=["count="+l];U==-1?l>0?(U=v[0].g,rt.push("ofs="+U)):U=0:rt.push("ofs="+U);let K=!0;for(let at=0;at<l;at++){var w=v[at].g;const Vt=v[at].map;if(w-=U,w<0)U=Math.max(0,v[at].g-100),K=!1;else try{w="req"+w+"_"||"";try{var C=Vt instanceof Map?Vt:Object.entries(Vt);for(const[oe,zt]of C){let $t=zt;c(zt)&&($t=Pr(zt)),rt.push(w+oe+"="+encodeURIComponent($t))}}catch(oe){throw rt.push(w+"type="+encodeURIComponent("_badmap")),oe}}catch{f&&f(Vt)}}if(K){C=rt.join("&");break t}}C=void 0}return s=s.i.splice(0,l),a.G=s,C}function Mi(s){if(!s.g&&!s.v){s.Y=1;var a=s.Da;It||m(),nt||(It(),nt=!0),E.add(a,s),s.A=0}}function qr(s){return s.g||s.v||s.A>=3?!1:(s.Y++,s.v=Fe(d(s.Da,s),Fi(s,s.A)),s.A++,!0)}r.Da=function(){if(this.v=null,Oi(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var s=4*this.T;this.j.info("BP detection timer enabled: "+s),this.B=Fe(d(this.Wa,this),s)}},r.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,yt(10),Dn(this),Oi(this))};function jr(s){s.B!=null&&(u.clearTimeout(s.B),s.B=null)}function Oi(s){s.g=new Ut(s,s.j,"rpc",s.Y),s.u===null&&(s.g.J=s.o),s.g.P=0;var a=Pt(s.na);W(a,"RID","rpc"),W(a,"SID",s.M),W(a,"AID",s.K),W(a,"CI",s.F?"0":"1"),!s.F&&s.ia&&W(a,"TO",s.ia),W(a,"TYPE","xmlhttp"),Xe(s,a),s.u&&s.o&&Fr(a,s.u,s.o),s.O&&(s.g.H=s.O);var l=s.g;s=s.ba,l.M=1,l.A=Sn(Pt(a)),l.u=null,l.R=!0,ci(l,s)}r.Va=function(){this.C!=null&&(this.C=null,Dn(this),qr(this),yt(19))};function kn(s){s.C!=null&&(u.clearTimeout(s.C),s.C=null)}function Li(s,a){var l=null;if(s.g==a){kn(s),jr(s),s.g=null;var f=2}else if(xr(s.h,a))l=a.G,pi(s.h,a),f=1;else return;if(s.I!=0){if(a.o)if(f==1){l=a.u?a.u.length:0,a=Date.now()-a.F;var v=s.D;f=Rn(),_t(f,new ii(f,l)),Nn(s)}else Mi(s);else if(v=a.m,v==3||v==0&&a.X>0||!(f==1&&nl(s,a)||f==2&&qr(s)))switch(l&&l.length>0&&(a=s.h,a.i=a.i.concat(l)),v){case 1:ie(s,5);break;case 4:ie(s,10);break;case 3:ie(s,6);break;default:ie(s,2)}}}function Fi(s,a){let l=s.Qa+Math.floor(Math.random()*s.Za);return s.isActive()||(l*=2),l*a}function ie(s,a){if(s.j.info("Error code "+a),a==2){var l=d(s.bb,s),f=s.Ua;const v=!f;f=new qt(f||"//www.google.com/images/cleardot.gif"),u.location&&u.location.protocol=="http"||Be(f,"https"),Sn(f),v?Xu(f.toString(),l):Yu(f.toString(),l)}else yt(2);s.I=0,s.l&&s.l.pa(a),Ui(s),Ni(s)}r.bb=function(s){s?(this.j.info("Successfully pinged google.com"),yt(2)):(this.j.info("Failed to ping google.com"),yt(1))};function Ui(s){if(s.I=0,s.ja=[],s.l){const a=_i(s.h);(a.length!=0||s.i.length!=0)&&(M(s.ja,a),M(s.ja,s.i),s.h.i.length=0,S(s.i),s.i.length=0),s.l.oa()}}function qi(s,a,l){var f=l instanceof qt?Pt(l):new qt(l);if(f.g!="")a&&(f.g=a+"."+f.g),ze(f,f.u);else{var v=u.location;f=v.protocol,a=a?a+"."+v.hostname:v.hostname,v=+v.port;const w=new qt(null);f&&Be(w,f),a&&(w.g=a),v&&ze(w,v),l&&(w.h=l),f=w}return l=s.G,a=s.wa,l&&a&&W(f,l,a),W(f,"VER",s.ka),Xe(s,f),f}function ji(s,a,l){if(a&&!s.L)throw Error("Can't create secondary domain capable XhrIo object.");return a=s.Aa&&!s.ma?new J(new Lr({ab:l})):new J(s.ma),a.Fa(s.L),a}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Bi(){}r=Bi.prototype,r.ra=function(){},r.qa=function(){},r.pa=function(){},r.oa=function(){},r.isActive=function(){return!0},r.Ka=function(){};function xn(){}xn.prototype.g=function(s,a){return new vt(s,a)};function vt(s,a){dt.call(this),this.g=new Di(a),this.l=s,this.h=a&&a.messageUrlParams||null,s=a&&a.messageHeaders||null,a&&a.clientProtocolHeaderRequired&&(s?s["X-Client-Protocol"]="webchannel":s={"X-Client-Protocol":"webchannel"}),this.g.o=s,s=a&&a.initMessageHeaders||null,a&&a.messageContentType&&(s?s["X-WebChannel-Content-Type"]=a.messageContentType:s={"X-WebChannel-Content-Type":a.messageContentType}),a&&a.sa&&(s?s["X-WebChannel-Client-Profile"]=a.sa:s={"X-WebChannel-Client-Profile":a.sa}),this.g.U=s,(s=a&&a.Qb)&&!g(s)&&(this.g.u=s),this.A=a&&a.supportsCrossDomainXhr||!1,this.v=a&&a.sendRawJson||!1,(a=a&&a.httpSessionIdParam)&&!g(a)&&(this.g.G=a,s=this.h,s!==null&&a in s&&(s=this.h,a in s&&delete s[a])),this.j=new _e(this)}I(vt,dt),vt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},vt.prototype.close=function(){Ur(this.g)},vt.prototype.o=function(s){var a=this.g;if(typeof s=="string"){var l={};l.__data__=s,s=l}else this.v&&(l={},l.__data__=Pr(s),s=l);a.i.push(new Bu(a.Ya++,s)),a.I==3&&Nn(a)},vt.prototype.N=function(){this.g.l=null,delete this.j,Ur(this.g),delete this.g,vt.Z.N.call(this)};function zi(s){Vr.call(this),s.__headers__&&(this.headers=s.__headers__,this.statusCode=s.__status__,delete s.__headers__,delete s.__status__);var a=s.__sm__;if(a){t:{for(const l in a){s=l;break t}s=void 0}(this.i=s)&&(s=this.i,a=a!==null&&s in a?a[s]:void 0),this.data=a}else this.data=s}I(zi,Vr);function $i(){Sr.call(this),this.status=1}I($i,Sr);function _e(s){this.g=s}I(_e,Bi),_e.prototype.ra=function(){_t(this.g,"a")},_e.prototype.qa=function(s){_t(this.g,new zi(s))},_e.prototype.pa=function(s){_t(this.g,new $i)},_e.prototype.oa=function(){_t(this.g,"b")},xn.prototype.createWebChannel=xn.prototype.g,vt.prototype.send=vt.prototype.o,vt.prototype.open=vt.prototype.m,vt.prototype.close=vt.prototype.close,Yo=function(){return new xn},Xo=function(){return Rn()},Ho=ne,Wr={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Pn.NO_ERROR=0,Pn.TIMEOUT=8,Pn.HTTP_ERROR=6,Bn=Pn,oi.COMPLETE="complete",Wo=oi,ei.EventType=Oe,Oe.OPEN="a",Oe.CLOSE="b",Oe.ERROR="c",Oe.MESSAGE="d",dt.prototype.listen=dt.prototype.J,Ye=ei,J.prototype.listenOnce=J.prototype.K,J.prototype.getLastError=J.prototype.Ha,J.prototype.getLastErrorCode=J.prototype.ya,J.prototype.getStatus=J.prototype.ca,J.prototype.getResponseJson=J.prototype.La,J.prototype.getResponseText=J.prototype.la,J.prototype.send=J.prototype.ea,J.prototype.setWithCredentials=J.prototype.Fa,Qo=J}).apply(typeof On<"u"?On:typeof self<"u"?self:typeof window<"u"?window:{});const Qi="@firebase/firestore",Wi="4.9.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const le=new ol("@firebase/firestore");function Ee(){return le.logLevel}function D(r,...t){if(le.logLevel<=Mt.DEBUG){const e=t.map(fs);le.debug(`Firestore (${De}): ${r}`,...e)}}function Lt(r,...t){if(le.logLevel<=Mt.ERROR){const e=t.map(fs);le.error(`Firestore (${De}): ${r}`,...e)}}function Re(r,...t){if(le.logLevel<=Mt.WARN){const e=t.map(fs);le.warn(`Firestore (${De}): ${r}`,...e)}}function fs(r){if(typeof r=="string")return r;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zo{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class Sl{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(gt.UNAUTHENTICATED))}shutdown(){}}class Cl{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class bl{constructor(t){this.t=t,this.currentUser=gt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){z(this.o===void 0,42304);let n=this.i;const i=h=>this.i!==n?(n=this.i,e(h)):Promise.resolve();let o=new Qt;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new Qt,t.enqueueRetryable(()=>i(this.currentUser))};const u=()=>{const h=o;t.enqueueRetryable(async()=>{await h.promise,await i(this.currentUser)})},c=h=>{D("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),u())};this.t.onInit(h=>c(h)),setTimeout(()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?c(h):(D("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new Qt)}},0),u()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(n=>this.i!==t?(D("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(z(typeof n.accessToken=="string",31837,{l:n}),new Zo(n.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return z(t===null||typeof t=="string",2055,{h:t}),new gt(t)}}class Dl{constructor(t,e,n){this.P=t,this.T=e,this.I=n,this.type="FirstParty",this.user=gt.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class Nl{constructor(t,e,n){this.P=t,this.T=e,this.I=n}getToken(){return Promise.resolve(new Dl(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable(()=>e(gt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Hi{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class kl{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,ll(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){z(this.o===void 0,3512);const n=o=>{o.error!=null&&D("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const u=o.token!==this.m;return this.m=o.token,D("FirebaseAppCheckTokenProvider",`Received ${u?"new":"existing"} token.`),u?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>n(o))};const i=o=>{D("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(o=>i(o)),setTimeout(()=>{if(!this.appCheck){const o=this.V.getImmediate({optional:!0});o?i(o):D("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Hi(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(z(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new Hi(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ds{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const i=xl(40);for(let o=0;o<i.length;++o)n.length<20&&i[o]<e&&(n+=t.charAt(i[o]%62))}return n}}function q(r,t){return r<t?-1:r>t?1:0}function Hr(r,t){const e=Math.min(r.length,t.length);for(let n=0;n<e;n++){const i=r.charAt(n),o=t.charAt(n);if(i!==o)return zr(i)===zr(o)?q(i,o):zr(i)?1:-1}return q(r.length,t.length)}const Ml=55296,Ol=57343;function zr(r){const t=r.charCodeAt(0);return t>=Ml&&t<=Ol}function Pe(r,t,e){return r.length===t.length&&r.every((n,i)=>e(n,t[i]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gs=-1;function or(r){return r==null}function Hn(r){return r===0&&1/r==-1/0}function Kl(r){return typeof r=="number"&&Number.isInteger(r)&&!Hn(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ea="";function Ql(r){let t="";for(let e=0;e<r.length;e++)t.length>0&&(t=to(t)),t=Wl(r.get(e),t);return to(t)}function Wl(r,t){let e=t;const n=r.length;for(let i=0;i<n;i++){const o=r.charAt(i);switch(o){case"\0":e+="";break;case ea:e+="";break;default:e+=o}}return e}function to(r){return r+ea+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xl{constructor(t,e,n,i,o,u,c,h,d,_){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=i,this.ssl=o,this.forceLongPolling=u,this.autoDetectLongPolling=c,this.longPollingOptions=h,this.useFetchStreams=d,this.isUsingEmulator=_}}const Xr="(default)";class ln{constructor(t,e){this.projectId=t,this.database=e||Xr}static empty(){return new ln("","")}get isDefaultDatabase(){return this.database===Xr}isEqual(t){return t instanceof ln&&t.projectId===this.projectId&&t.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At{constructor(t){this.value=t}static empty(){return new At({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let n=0;n<t.length-1;++n)if(e=(e.mapValue.fields||{})[t.get(n)],!$n(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=en(e)}setAll(t){let e=ct.emptyPath(),n={},i=[];t.forEach((u,c)=>{if(!e.isImmediateParentOf(c)){const h=this.getFieldsMap(e);this.applyChanges(h,n,i),n={},i=[],e=c.popLast()}u?n[c.lastSegment()]=en(u):i.push(c.lastSegment())});const o=this.getFieldsMap(e);this.applyChanges(o,n,i)}delete(t){const e=this.field(t.popLast());$n(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return kt(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let n=0;n<t.length;++n){let i=e.mapValue.fields[t.get(n)];$n(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},e.mapValue.fields[t.get(n)]=i),e=i}return e.mapValue.fields}applyChanges(t,e,n){he(e,(i,o)=>t[i]=o);for(const i of n)delete t[i]}clone(){return new At(en(this.value))}}function ca(r){const t=[];return he(r.fields,(e,n)=>{const i=new ct([e]);if($n(n)){const o=ca(n.mapValue).fields;if(o.length===0)t.push(i);else for(const u of o)t.push(i.child(u))}else t.push(i)}),new Rt(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{constructor(t,e="asc"){this.field=t,this.dir=e}}function tc(r,t){return r.dir===t.dir&&r.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ts(r,t){if(r.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Hn(t)?"-0":t}}function va(r){return{integerValue:""+r}}function Tc(r,t){return Kl(t)?va(t):Ts(r,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ac{constructor(t,e){this.field=t,this.transform=e}}function wc(r,t){return r.field.isEqual(t.field)&&function(n,i){return n instanceof fn&&i instanceof fn||n instanceof dn&&i instanceof dn?Pe(n.elements,i.elements,kt):n instanceof Zn&&i instanceof Zn?kt(n.Ae,i.Ae):n instanceof hn&&i instanceof hn}(r.transform,t.transform)}class Rc{constructor(t,e){this.version=t,this.transformResults=e}}class Ot{constructor(t,e){this.updateTime=t,this.exists=e}static none(){return new Ot}static exists(t){return new Ot(void 0,t)}static updateTime(t){return new Ot(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function Gn(r,t){return r.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(r.updateTime):r.exists===void 0||r.exists===t.isFoundDocument()}class dr{}function Va(r,t){if(!r.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return r.isNoDocument()?new Ca(r.key,Ot.none()):new _n(r.key,r.data,Ot.none());{const e=r.data,n=At.empty();let i=new ot(ct.comparator);for(let o of t.fields)if(!i.has(o)){let u=e.field(o);u===null&&o.length>1&&(o=o.popLast(),u=e.field(o)),u===null?n.delete(o):n.set(o,u),i=i.add(o)}return new de(r.key,n,new Rt(i.toArray()),Ot.none())}}function Pc(r,t,e){r instanceof _n?function(i,o,u){const c=i.value.clone(),h=mo(i.fieldTransforms,o,u.transformResults);c.setAll(h),o.convertToFoundDocument(u.version,c).setHasCommittedMutations()}(r,t,e):r instanceof de?function(i,o,u){if(!Gn(i.precondition,o))return void o.convertToUnknownDocument(u.version);const c=mo(i.fieldTransforms,o,u.transformResults),h=o.data;h.setAll(Sa(i)),h.setAll(c),o.convertToFoundDocument(u.version,h).setHasCommittedMutations()}(r,t,e):function(i,o,u){o.convertToNoDocument(u.version).setHasCommittedMutations()}(0,t,e)}function sn(r,t,e,n){return r instanceof _n?function(o,u,c,h){if(!Gn(o.precondition,u))return c;const d=o.value.clone(),_=go(o.fieldTransforms,h,u);return d.setAll(_),u.convertToFoundDocument(u.version,d).setHasLocalMutations(),null}(r,t,e,n):r instanceof de?function(o,u,c,h){if(!Gn(o.precondition,u))return c;const d=go(o.fieldTransforms,h,u),_=u.data;return _.setAll(Sa(o)),_.setAll(d),u.convertToFoundDocument(u.version,_).setHasLocalMutations(),c===null?null:c.unionWith(o.fieldMask.fields).unionWith(o.fieldTransforms.map(I=>I.field))}(r,t,e,n):function(o,u,c){return Gn(o.precondition,u)?(u.convertToNoDocument(u.version).setHasLocalMutations(),null):c}(r,t,e)}function Vc(r,t){let e=null;for(const n of r.fieldTransforms){const i=t.data.field(n.field),o=Aa(n.transform,i||null);o!=null&&(e===null&&(e=At.empty()),e.set(n.field,o))}return e||null}function fo(r,t){return r.type===t.type&&!!r.key.isEqual(t.key)&&!!r.precondition.isEqual(t.precondition)&&!!function(n,i){return n===void 0&&i===void 0||!(!n||!i)&&Pe(n,i,(o,u)=>wc(o,u))}(r.fieldTransforms,t.fieldTransforms)&&(r.type===0?r.value.isEqual(t.value):r.type!==1||r.data.isEqual(t.data)&&r.fieldMask.isEqual(t.fieldMask))}class _n extends dr{constructor(t,e,n,i=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class de extends dr{constructor(t,e,n,i,o=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=i,this.fieldTransforms=o,this.type=1}getFieldMask(){return this.fieldMask}}function Sa(r){const t=new Map;return r.fieldMask.fields.forEach(e=>{if(!e.isEmpty()){const n=r.data.field(e);t.set(e,n)}}),t}function mo(r,t,e){const n=new Map;z(r.length===e.length,32656,{Re:e.length,Ve:r.length});for(let i=0;i<e.length;i++){const o=r[i],u=o.transform,c=t.data.field(o.field);n.set(o.field,vc(u,c,e[i]))}return n}function go(r,t,e){const n=new Map;for(const i of r){const o=i.transform,u=e.data.field(i.field);n.set(i.field,Ic(o,u,t))}return n}class Ca extends dr{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Sc extends dr{constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zc{constructor(t){this.yt=t}}function th(r){const t=Qc({parent:r.parent,structuredQuery:r.structuredQuery});return r.limitType==="LAST"?es(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ch{constructor(t,e,n,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=i}getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(n=i,this.remoteDocumentCache.getEntry(t,e))).next(i=>(n!==null&&sn(n.mutation,i,Rt.empty(),H.now()),i))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.getLocalViewOfDocuments(t,n,j()).next(()=>n))}getLocalViewOfDocuments(t,e,n=j()){const i=ae();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,n).next(o=>{let u=Je();return o.forEach((c,h)=>{u=u.insert(c,h.overlayedDocument)}),u}))}getOverlayedDocuments(t,e){const n=ae();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,j()))}populateOverlays(t,e,n){const i=[];return n.forEach(o=>{e.has(o)||i.push(o)}),this.documentOverlayCache.getOverlays(t,i).next(o=>{o.forEach((u,c)=>{e.set(u,c)})})}computeViews(t,e,n,i){let o=Ft();const u=rn(),c=function(){return rn()}();return e.forEach((h,d)=>{const _=n.get(d.key);i.has(d.key)&&(_===void 0||_.mutation instanceof de)?o=o.insert(d.key,d):_!==void 0?(u.set(d.key,_.mutation.getFieldMask()),sn(_.mutation,d,_.mutation.getFieldMask(),H.now())):u.set(d.key,Rt.empty())}),this.recalculateAndSaveOverlays(t,o).next(h=>(h.forEach((d,_)=>u.set(d,_)),e.forEach((d,_)=>c.set(d,new lh(_,u.get(d)??null))),c))}recalculateAndSaveOverlays(t,e){const n=rn();let i=new Y((u,c)=>u-c),o=j();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(u=>{for(const c of u)c.keys().forEach(h=>{const d=e.get(h);if(d===null)return;let _=n.get(h)||Rt.empty();_=c.applyToLocalView(d,_),n.set(h,_);const I=(i.get(c.batchId)||j()).add(h);i=i.insert(c.batchId,I)})}).next(()=>{const u=[],c=i.getReverseIterator();for(;c.hasNext();){const h=c.getNext(),d=h.key,_=h.value,I=Ia();_.forEach(P=>{if(!o.has(P)){const S=Va(e.get(P),n.get(P));S!==null&&I.set(P,S),o=o.add(P)}}),u.push(this.documentOverlayCache.saveOverlays(t,d,I))}return R.waitFor(u)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.recalculateAndSaveOverlays(t,n))}getDocumentsMatchingQuery(t,e,n,i){return function(u){return x.isDocumentKey(u.path)&&u.collectionGroup===null&&u.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):hc(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,i):this.getDocumentsMatchingCollectionQuery(t,e,n,i)}getNextDocuments(t,e,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,i).next(o=>{const u=i-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,i-o.size):R.resolve(ae());let c=an,h=o;return u.next(d=>R.forEach(d,(_,I)=>(c<I.largestBatchId&&(c=I.largestBatchId),o.get(_)?R.resolve():this.remoteDocumentCache.getEntry(t,_).next(P=>{h=h.insert(_,P)}))).next(()=>this.populateOverlays(t,d,o)).next(()=>this.computeViews(t,h,d,j())).next(_=>({batchId:c,changes:Ta(_)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new x(e)).next(n=>{let i=Je();return n.isFoundDocument()&&(i=i.insert(n.key,n)),i})}getDocumentsMatchingCollectionGroupQuery(t,e,n,i){const o=e.collectionGroup;let u=Je();return this.indexManager.getCollectionParents(t,o).next(c=>R.forEach(c,h=>{const d=function(I,P){return new ur(P,null,I.explicitOrderBy.slice(),I.filters.slice(),I.limit,I.limitType,I.startAt,I.endAt)}(e,h.child(o));return this.getDocumentsMatchingCollectionQuery(t,d,n,i).next(_=>{_.forEach((I,P)=>{u=u.insert(I,P)})})}).next(()=>u))}getDocumentsMatchingCollectionQuery(t,e,n,i){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,n.largestBatchId).next(u=>(o=u,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,n,o,i))).next(u=>{o.forEach((h,d)=>{const _=d.getKey();u.get(_)===null&&(u=u.insert(_,pt.newInvalidDocument(_)))});let c=Je();return u.forEach((h,d)=>{const _=o.get(h);_!==void 0&&sn(_.mutation,d,Rt.empty(),H.now()),hr(e,d)&&(c=c.insert(h,d))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{constructor(t){this.ri=t,this.docs=function(){return new Y(x.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,i=this.docs.get(n),o=i?i.size:0,u=this.ri(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:u}),this.size+=u-o,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return R.resolve(n?n.document.mutableCopy():pt.newInvalidDocument(e))}getEntries(t,e){let n=Ft();return e.forEach(i=>{const o=this.docs.get(i);n=n.insert(i,o?o.document.mutableCopy():pt.newInvalidDocument(i))}),R.resolve(n)}getDocumentsMatchingQuery(t,e,n,i){let o=Ft();const u=e.path,c=new x(u.child("__id-9223372036854775808__")),h=this.docs.getIteratorFrom(c);for(;h.hasNext();){const{key:d,value:{document:_}}=h.getNext();if(!u.isPrefixOf(d.path))break;d.path.length>u.length+1||Bl(jl(_),n)<=0||(i.has(_.key)||hr(e,_))&&(o=o.insert(_.key,_.mutableCopy()))}return R.resolve(o)}getAllFromCollectionGroup(t,e,n,i){O(9500)}ii(t,e){return R.forEach(this.docs,n=>e(n))}newChangeBuffer(t){return new ph(this)}getSize(t){return R.resolve(this.size)}}class ph extends uh{constructor(t){super(),this.Nr=t}applyChanges(t){const e=[];return this.changes.forEach((n,i)=>{i.isValidDocument()?e.push(this.Nr.addEntry(t,i)):this.Nr.removeEntry(n)}),R.waitFor(e)}getFromCache(t,e){return this.Nr.getEntry(t,e)}getAllFromCache(t,e){return this.Nr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Th{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return yl()?8:Gl(El())>0?6:4}()}initialize(t,e){this.ps=t,this.indexManager=e,this.Rs=!0}getDocumentsMatchingQuery(t,e,n,i){const o={result:null};return this.ys(t,e).next(u=>{o.result=u}).next(()=>{if(!o.result)return this.ws(t,e,i,n).next(u=>{o.result=u})}).next(()=>{if(o.result)return;const u=new Eh;return this.Ss(t,e,u).next(c=>{if(o.result=c,this.Vs)return this.bs(t,e,u,c.size)})}).next(()=>o.result)}bs(t,e,n,i){return n.documentReadCount<this.fs?(Ee()<=Mt.DEBUG&&D("QueryEngine","SDK will not create cache indexes for query:",Te(e),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),R.resolve()):(Ee()<=Mt.DEBUG&&D("QueryEngine","Query:",Te(e),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.gs*i?(Ee()<=Mt.DEBUG&&D("QueryEngine","The SDK decides to create cache indexes for query:",Te(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Ct(e))):R.resolve())}ys(t,e){if(co(e))return R.resolve(null);let n=Ct(e);return this.indexManager.getIndexType(t,n).next(i=>i===0?null:(e.limit!==null&&i===1&&(e=es(e,null,"F"),n=Ct(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next(o=>{const u=j(...o);return this.ps.getDocuments(t,u).next(c=>this.indexManager.getMinOffset(t,n).next(h=>{const d=this.Ds(e,c);return this.Cs(e,d,u,h.readTime)?this.ys(t,es(e,null,"F")):this.vs(t,d,e,h)}))})))}ws(t,e,n,i){return co(e)||i.isEqual(L.min())?R.resolve(null):this.ps.getDocuments(t,n).next(o=>{const u=this.Ds(e,o);return this.Cs(e,u,n,i)?R.resolve(null):(Ee()<=Mt.DEBUG&&D("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Te(e)),this.vs(t,u,e,ql(i,an)).next(c=>c))})}Ds(t,e){let n=new ot(ya(t));return e.forEach((i,o)=>{hr(t,o)&&(n=n.add(o))}),n}Cs(t,e,n,i){if(t.limit===null)return!1;if(n.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}Ss(t,e,n){return Ee()<=Mt.DEBUG&&D("QueryEngine","Using full collection scan to execute query:",Te(e)),this.ps.getDocumentsMatchingQuery(t,e,Ht.min(),n)}vs(t,e,n,i){return this.ps.getDocumentsMatchingQuery(t,n,i).next(o=>(e.forEach(u=>{o=o.insert(u.key,u)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vs="LocalStore",Ih=3e8;class vh{constructor(t,e,n,i){this.persistence=t,this.Fs=e,this.serializer=i,this.Ms=new Y(q),this.xs=new fe(o=>ys(o),Es),this.Os=new Map,this.Ns=t.getRemoteDocumentCache(),this.Pi=t.getTargetCache(),this.Ii=t.getBundleCache(),this.Bs(n)}Bs(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new ch(this.Ns,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Ns.setIndexManager(this.indexManager),this.Fs.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",e=>t.collect(e,this.Ms))}}function Ah(r,t,e,n){return new vh(r,t,e,n)}async function Ba(r,t){const e=F(r);return await e.persistence.runTransaction("Handle user change","readonly",n=>{let i;return e.mutationQueue.getAllMutationBatches(n).next(o=>(i=o,e.Bs(t),e.mutationQueue.getAllMutationBatches(n))).next(o=>{const u=[],c=[];let h=j();for(const d of i){u.push(d.batchId);for(const _ of d.mutations)h=h.add(_.key)}for(const d of o){c.push(d.batchId);for(const _ of d.mutations)h=h.add(_.key)}return e.localDocuments.getDocuments(n,h).next(d=>({Ls:d,removedBatchIds:u,addedBatchIds:c}))})})}function wh(r,t){const e=F(r);return e.persistence.runTransaction("Acknowledge batch","readwrite-primary",n=>{const i=t.batch.keys(),o=e.Ns.newChangeBuffer({trackRemovals:!0});return function(c,h,d,_){const I=d.batch,P=I.keys();let S=R.resolve();return P.forEach(M=>{S=S.next(()=>_.getEntry(h,M)).next(k=>{const b=d.docVersions.get(M);z(b!==null,48541),k.version.compareTo(b)<0&&(I.applyToRemoteDocument(k,d),k.isValidDocument()&&(k.setReadTime(d.commitVersion),_.addEntry(k)))})}),S.next(()=>c.mutationQueue.removeMutationBatch(h,I))}(e,n,t,o).next(()=>o.apply(n)).next(()=>e.mutationQueue.performConsistencyCheck(n)).next(()=>e.documentOverlayCache.removeOverlaysForBatchId(n,i,t.batch.batchId)).next(()=>e.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,function(c){let h=j();for(let d=0;d<c.mutationResults.length;++d)c.mutationResults[d].transformResults.length>0&&(h=h.add(c.batch.mutations[d].key));return h}(t))).next(()=>e.localDocuments.getDocuments(n,i))})}function za(r){const t=F(r);return t.persistence.runTransaction("Get last remote snapshot version","readonly",e=>t.Pi.getLastRemoteSnapshotVersion(e))}function Rh(r,t){const e=F(r),n=t.snapshotVersion;let i=e.Ms;return e.persistence.runTransaction("Apply remote event","readwrite-primary",o=>{const u=e.Ns.newChangeBuffer({trackRemovals:!0});i=e.Ms;const c=[];t.targetChanges.forEach((_,I)=>{const P=i.get(I);if(!P)return;c.push(e.Pi.removeMatchingKeys(o,_.removedDocuments,I).next(()=>e.Pi.addMatchingKeys(o,_.addedDocuments,I)));let S=P.withSequenceNumber(o.currentSequenceNumber);t.targetMismatches.get(I)!==null?S=S.withResumeToken(ht.EMPTY_BYTE_STRING,L.min()).withLastLimboFreeSnapshotVersion(L.min()):_.resumeToken.approximateByteSize()>0&&(S=S.withResumeToken(_.resumeToken,n)),i=i.insert(I,S),function(k,b,$){return k.resumeToken.approximateByteSize()===0||b.snapshotVersion.toMicroseconds()-k.snapshotVersion.toMicroseconds()>=Ih?!0:$.addedDocuments.size+$.modifiedDocuments.size+$.removedDocuments.size>0}(P,S,_)&&c.push(e.Pi.updateTargetData(o,S))});let h=Ft(),d=j();if(t.documentUpdates.forEach(_=>{t.resolvedLimboDocuments.has(_)&&c.push(e.persistence.referenceDelegate.updateLimboDocument(o,_))}),c.push(Ph(o,u,t.documentUpdates).next(_=>{h=_.ks,d=_.qs})),!n.isEqual(L.min())){const _=e.Pi.getLastRemoteSnapshotVersion(o).next(I=>e.Pi.setTargetsMetadata(o,o.currentSequenceNumber,n));c.push(_)}return R.waitFor(c).next(()=>u.apply(o)).next(()=>e.localDocuments.getLocalViewOfDocuments(o,h,d)).next(()=>h)}).then(o=>(e.Ms=i,o))}function Ph(r,t,e){let n=j(),i=j();return e.forEach(o=>n=n.add(o)),t.getEntries(r,n).next(o=>{let u=Ft();return e.forEach((c,h)=>{const d=o.get(c);h.isFoundDocument()!==d.isFoundDocument()&&(i=i.add(c)),h.isNoDocument()&&h.version.isEqual(L.min())?(t.removeEntry(c,h.readTime),u=u.insert(c,h)):!d.isValidDocument()||h.version.compareTo(d.version)>0||h.version.compareTo(d.version)===0&&d.hasPendingWrites?(t.addEntry(h),u=u.insert(c,h)):D(Vs,"Ignoring outdated watch update for ",c,". Current version:",d.version," Watch version:",h.version)}),{ks:u,qs:i}})}function Vh(r,t){const e=F(r);return e.persistence.runTransaction("Get next mutation batch","readonly",n=>(t===void 0&&(t=gs),e.mutationQueue.getNextMutationBatchAfterBatchId(n,t)))}function Sh(r,t){const e=F(r);return e.persistence.runTransaction("Allocate target","readwrite",n=>{let i;return e.Pi.getTargetData(n,t).next(o=>o?(i=o,R.resolve(i)):e.Pi.allocateTargetId(n).next(u=>(i=new Gt(t,u,"TargetPurposeListen",n.currentSequenceNumber),e.Pi.addTargetData(n,i).next(()=>i))))}).then(n=>{const i=e.Ms.get(n.targetId);return(i===null||n.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(e.Ms=e.Ms.insert(n.targetId,n),e.xs.set(t,n.targetId)),n})}async function os(r,t,e){const n=F(r),i=n.Ms.get(t),o=e?"readwrite":"readwrite-primary";try{e||await n.persistence.runTransaction("Release target",o,u=>n.persistence.referenceDelegate.removeTarget(u,i))}catch(u){if(!ke(u))throw u;D(Vs,`Failed to update sequence numbers for target ${t}: ${u}`)}n.Ms=n.Ms.remove(t),n.xs.delete(i.target)}function wo(r,t,e){const n=F(r);let i=L.min(),o=j();return n.persistence.runTransaction("Execute query","readwrite",u=>function(h,d,_){const I=F(h),P=I.xs.get(_);return P!==void 0?R.resolve(I.Ms.get(P)):I.Pi.getTargetData(d,_)}(n,u,Ct(t)).next(c=>{if(c)return i=c.lastLimboFreeSnapshotVersion,n.Pi.getMatchingKeysForTargetId(u,c.targetId).next(h=>{o=h})}).next(()=>n.Fs.getDocumentsMatchingQuery(u,t,e?i:L.min(),e?o:j())).next(c=>(Ch(n,dc(t),c),{documents:c,Qs:o})))}function Ch(r,t,e){let n=r.Os.get(t)||L.min();e.forEach((i,o)=>{o.readTime.compareTo(n)>0&&(n=o.readTime)}),r.Os.set(t,n)}class Ro{constructor(){this.activeTargetIds=Ec()}zs(t){this.activeTargetIds=this.activeTargetIds.add(t)}js(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Gs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class bh{constructor(){this.Mo=new Ro,this.xo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,e,n){}addLocalQueryTarget(t,e=!0){return e&&this.Mo.zs(t),this.xo[t]||"not-current"}updateQueryState(t,e,n){this.xo[t]=e}removeLocalQueryTarget(t){this.Mo.js(t)}isLocalQueryTarget(t){return this.Mo.activeTargetIds.has(t)}clearQueryState(t){delete this.xo[t]}getAllActiveQueryTargets(){return this.Mo.activeTargetIds}isActiveQueryTarget(t){return this.Mo.activeTargetIds.has(t)}start(){return this.Mo=new Ro,Promise.resolve()}handleUserChange(t,e,n){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mt="WebChannelConnection";class Mh extends kh{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,n,i,o){const u=as();return new Promise((c,h)=>{const d=new Qo;d.setWithCredentials(!0),d.listenOnce(Wo.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Bn.NO_ERROR:const I=d.getResponseJson();D(mt,`XHR for RPC '${t}' ${u} received:`,JSON.stringify(I)),c(I);break;case Bn.TIMEOUT:D(mt,`RPC '${t}' ${u} timed out`),h(new N(V.DEADLINE_EXCEEDED,"Request time out"));break;case Bn.HTTP_ERROR:const P=d.getStatus();if(D(mt,`RPC '${t}' ${u} failed with status:`,P,"response text:",d.getResponseText()),P>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const M=S==null?void 0:S.error;if(M&&M.status&&M.message){const k=function($){const G=$.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(G)>=0?G:V.UNKNOWN}(M.status);h(new N(k,M.message))}else h(new N(V.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new N(V.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:t,streamId:u,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{D(mt,`RPC '${t}' ${u} completed.`)}});const _=JSON.stringify(i);D(mt,`RPC '${t}' ${u} sending request:`,i),d.send(e,"POST",_,n,15)})}T_(t,e,n){const i=as(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],u=Yo(),c=Xo(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,e,n),h.encodeInitMessageHeaders=!0;const _=o.join("");D(mt,`Creating RPC '${t}' stream ${i}: ${_}`,h);const I=u.createWebChannel(_,h);this.I_(I);let P=!1,S=!1;const M=new xh({Yo:b=>{S?D(mt,`Not sending because RPC '${t}' stream ${i} is closed:`,b):(P||(D(mt,`Opening RPC '${t}' stream ${i} transport.`),I.open(),P=!0),D(mt,`RPC '${t}' stream ${i} sending:`,b),I.send(b))},Zo:()=>I.close()}),k=(b,$,G)=>{b.listen($,Q=>{try{G(Q)}catch(ft){setTimeout(()=>{throw ft},0)}})};return k(I,Ye.EventType.OPEN,()=>{S||(D(mt,`RPC '${t}' stream ${i} transport opened.`),M.o_())}),k(I,Ye.EventType.CLOSE,()=>{S||(S=!0,D(mt,`RPC '${t}' stream ${i} transport closed`),M.a_(),this.E_(I))}),k(I,Ye.EventType.ERROR,b=>{S||(S=!0,Re(mt,`RPC '${t}' stream ${i} transport errored. Name:`,b.name,"Message:",b.message),M.a_(new N(V.UNAVAILABLE,"The operation could not be completed")))}),k(I,Ye.EventType.MESSAGE,b=>{var $;if(!S){const G=b.data[0];z(!!G,16349);const Q=G,ft=(Q==null?void 0:Q.error)||(($=Q[0])==null?void 0:$.error);if(ft){D(mt,`RPC '${t}' stream ${i} received error:`,ft);const It=ft.status;let nt=function(p){const T=tt[p];if(T!==void 0)return ba(T)}(It),E=ft.message;nt===void 0&&(nt=V.INTERNAL,E="Unknown error status: "+It+" with message "+ft.message),S=!0,M.a_(new N(nt,E)),I.close()}else D(mt,`RPC '${t}' stream ${i} received:`,G),M.u_(G)}}),k(c,Ho.STAT_EVENT,b=>{b.stat===Wr.PROXY?D(mt,`RPC '${t}' stream ${i} detected buffering proxy`):b.stat===Wr.NOPROXY&&D(mt,`RPC '${t}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{M.__()},0),M}terminate(){this.c_.forEach(t=>t.close()),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter(e=>e===t)}}function Kr(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So="PersistentStream";class Ga{constructor(t,e,n,i,o,u,c,h){this.Mi=t,this.S_=n,this.b_=i,this.connection=o,this.authCredentialsProvider=u,this.appCheckCredentialsProvider=c,this.listener=h,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new $a(t,e)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,()=>this.k_()))}q_(t){this.Q_(),this.stream.send(t)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,e){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,t!==4?this.M_.reset():e&&e.code===V.RESOURCE_EXHAUSTED?(Lt(e.toString()),Lt("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):e&&e.code===V.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.r_(e)}K_(){}auth(){this.state=1;const t=this.W_(this.D_),e=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,i])=>{this.D_===e&&this.G_(n,i)},n=>{t(()=>{const i=new N(V.UNKNOWN,"Fetching auth token failed: "+n.message);return this.z_(i)})})}G_(t,e){const n=this.W_(this.D_);this.stream=this.j_(t,e),this.stream.Xo(()=>{n(()=>this.listener.Xo())}),this.stream.t_(()=>{n(()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,()=>(this.O_()&&(this.state=3),Promise.resolve())),this.listener.t_()))}),this.stream.r_(i=>{n(()=>this.z_(i))}),this.stream.onMessage(i=>{n(()=>++this.F_==1?this.J_(i):this.onNext(i))})}N_(){this.state=5,this.M_.p_(async()=>{this.state=0,this.start()})}z_(t){return D(So,`close with error: ${t}`),this.stream=null,this.close(4,t)}W_(t){return e=>{this.Mi.enqueueAndForget(()=>this.D_===t?e():(D(So,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class Oh extends Ga{constructor(t,e,n,i,o,u){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,i,u),this.serializer=o}j_(t,e){return this.connection.T_("Listen",t,e)}J_(t){return this.onNext(t)}onNext(t){this.M_.reset();const e=Bc(this.serializer,t),n=function(o){if(!("targetChange"in o))return L.min();const u=o.targetChange;return u.targetIds&&u.targetIds.length?L.min():u.readTime?bt(u.readTime):L.min()}(t);return this.listener.H_(e,n)}Y_(t){const e={};e.database=is(this.serializer),e.addTarget=function(o,u){let c;const h=u.target;if(c=ts(h)?{documents:Gc(o,h)}:{query:Kc(o,h).ft},c.targetId=u.targetId,u.resumeToken.approximateByteSize()>0){c.resumeToken=ka(o,u.resumeToken);const d=ns(o,u.expectedCount);d!==null&&(c.expectedCount=d)}else if(u.snapshotVersion.compareTo(L.min())>0){c.readTime=tr(o,u.snapshotVersion.toTimestamp());const d=ns(o,u.expectedCount);d!==null&&(c.expectedCount=d)}return c}(this.serializer,t);const n=Wc(this.serializer,t);n&&(e.labels=n),this.q_(e)}Z_(t){const e={};e.database=is(this.serializer),e.removeTarget=t,this.q_(e)}}class Lh extends Ga{constructor(t,e,n,i,o,u){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,i,u),this.serializer=o}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(t,e){return this.connection.T_("Write",t,e)}J_(t){return z(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,z(!t.writeResults||t.writeResults.length===0,55816),this.listener.ta()}onNext(t){z(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.M_.reset();const e=$c(t.writeResults,t.commitTime),n=bt(t.commitTime);return this.listener.na(n,e)}ra(){const t={};t.database=is(this.serializer),this.q_(t)}ea(t){const e={streamToken:this.lastStreamToken,writes:t.map(n=>zc(this.serializer,n))};this.q_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ce="RemoteStore";class jh{constructor(t,e,n,i,o){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo(u=>{n.enqueueAndForget(async()=>{me(this)&&(D(ce,"Restarting streams for network reachability change."),await async function(h){const d=F(h);d.Ea.add(4),await En(d),d.Ra.set("Unknown"),d.Ea.delete(4),await pr(d)}(this))})}),this.Ra=new qh(n,i)}}async function pr(r){if(me(r))for(const t of r.da)await t(!0)}async function En(r){for(const t of r.da)await t(!1)}function Ka(r,t){const e=F(r);e.Ia.has(t.targetId)||(e.Ia.set(t.targetId,t),Ds(e)?bs(e):xe(e).O_()&&Cs(e,t))}function Ss(r,t){const e=F(r),n=xe(e);e.Ia.delete(t),n.O_()&&Qa(e,t),e.Ia.size===0&&(n.O_()?n.L_():me(e)&&e.Ra.set("Unknown"))}function Cs(r,t){if(r.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(L.min())>0){const e=r.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(e)}xe(r).Y_(t)}function Qa(r,t){r.Va.Ue(t),xe(r).Z_(t)}function bs(r){r.Va=new Mc({getRemoteKeysForTarget:t=>r.remoteSyncer.getRemoteKeysForTarget(t),At:t=>r.Ia.get(t)||null,ht:()=>r.datastore.serializer.databaseId}),xe(r).start(),r.Ra.ua()}function Ds(r){return me(r)&&!xe(r).x_()&&r.Ia.size>0}function me(r){return F(r).Ea.size===0}function Wa(r){r.Va=void 0}async function Bh(r){r.Ra.set("Online")}async function zh(r){r.Ia.forEach((t,e)=>{Cs(r,t)})}async function $h(r,t){Wa(r),Ds(r)?(r.Ra.ha(t),bs(r)):r.Ra.set("Unknown")}async function Gh(r,t,e){if(r.Ra.set("Online"),t instanceof Na&&t.state===2&&t.cause)try{await async function(i,o){const u=o.cause;for(const c of o.targetIds)i.Ia.has(c)&&(await i.remoteSyncer.rejectListen(c,u),i.Ia.delete(c),i.Va.removeTarget(c))}(r,t)}catch(n){D(ce,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await nr(r,n)}else if(t instanceof Kn?r.Va.Ze(t):t instanceof Da?r.Va.st(t):r.Va.tt(t),!e.isEqual(L.min()))try{const n=await za(r.localStore);e.compareTo(n)>=0&&await function(o,u){const c=o.Va.Tt(u);return c.targetChanges.forEach((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const _=o.Ia.get(d);_&&o.Ia.set(d,_.withResumeToken(h.resumeToken,u))}}),c.targetMismatches.forEach((h,d)=>{const _=o.Ia.get(h);if(!_)return;o.Ia.set(h,_.withResumeToken(ht.EMPTY_BYTE_STRING,_.snapshotVersion)),Qa(o,h);const I=new Gt(_.target,h,d,_.sequenceNumber);Cs(o,I)}),o.remoteSyncer.applyRemoteEvent(c)}(r,e)}catch(n){D(ce,"Failed to raise snapshot:",n),await nr(r,n)}}async function nr(r,t,e){if(!ke(t))throw t;r.Ea.add(1),await En(r),r.Ra.set("Offline"),e||(e=()=>za(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{D(ce,"Retrying IndexedDB access"),await e(),r.Ea.delete(1),await pr(r)})}function Ha(r,t){return t().catch(e=>nr(r,e,t))}async function _r(r){const t=F(r),e=Zt(t);let n=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:gs;for(;Kh(t);)try{const i=await Vh(t.localStore,n);if(i===null){t.Ta.length===0&&e.L_();break}n=i.batchId,Qh(t,i)}catch(i){await nr(t,i)}Xa(t)&&Ya(t)}function Kh(r){return me(r)&&r.Ta.length<10}function Qh(r,t){r.Ta.push(t);const e=Zt(r);e.O_()&&e.X_&&e.ea(t.mutations)}function Xa(r){return me(r)&&!Zt(r).x_()&&r.Ta.length>0}function Ya(r){Zt(r).start()}async function Wh(r){Zt(r).ra()}async function Hh(r){const t=Zt(r);for(const e of r.Ta)t.ea(e.mutations)}async function Xh(r,t,e){const n=r.Ta.shift(),i=Is.from(n,t,e);await Ha(r,()=>r.remoteSyncer.applySuccessfulWrite(i)),await _r(r)}async function Yh(r,t){t&&Zt(r).X_&&await async function(n,i){if(function(u){return Nc(u)&&u!==V.ABORTED}(i.code)){const o=n.Ta.shift();Zt(n).B_(),await Ha(n,()=>n.remoteSyncer.rejectFailedWrite(o.batchId,i)),await _r(n)}}(r,t),Xa(r)&&Ya(r)}async function Co(r,t){const e=F(r);e.asyncQueue.verifyOperationInProgress(),D(ce,"RemoteStore received new credentials");const n=me(e);e.Ea.add(3),await En(e),n&&e.Ra.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.Ea.delete(3),await pr(e)}async function Jh(r,t){const e=F(r);t?(e.Ea.delete(2),await pr(e)):t||(e.Ea.add(2),await En(e),e.Ra.set("Unknown"))}function xe(r){return r.ma||(r.ma=function(e,n,i){const o=F(e);return o.sa(),new Oh(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(r.datastore,r.asyncQueue,{Xo:Bh.bind(null,r),t_:zh.bind(null,r),r_:$h.bind(null,r),H_:Gh.bind(null,r)}),r.da.push(async t=>{t?(r.ma.B_(),Ds(r)?bs(r):r.Ra.set("Unknown")):(await r.ma.stop(),Wa(r))})),r.ma}function Zt(r){return r.fa||(r.fa=function(e,n,i){const o=F(e);return o.sa(),new Lh(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(r.datastore,r.asyncQueue,{Xo:()=>Promise.resolve(),t_:Wh.bind(null,r),r_:Yh.bind(null,r),ta:Hh.bind(null,r),na:Xh.bind(null,r)}),r.da.push(async t=>{t?(r.fa.B_(),await _r(r)):(await r.fa.stop(),r.Ta.length>0&&(D(ce,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))})),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zh{constructor(){this.wa=void 0,this.Sa=[]}ba(){return this.Sa.some(t=>t.Da())}}class tf{constructor(){this.queries=Do(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(e,n){const i=F(e),o=i.queries;i.queries=Do(),o.forEach((u,c)=>{for(const h of c.Sa)h.onError(n)})})(this,new N(V.ABORTED,"Firestore shutting down"))}}function Do(){return new fe(r=>_a(r),cr)}async function Ja(r,t){const e=F(r);let n=3;const i=t.query;let o=e.queries.get(i);o?!o.ba()&&t.Da()&&(n=2):(o=new Zh,n=t.Da()?0:1);try{switch(n){case 0:o.wa=await e.onListen(i,!0);break;case 1:o.wa=await e.onListen(i,!1);break;case 2:await e.onFirstRemoteStoreListen(i)}}catch(u){const c=ks(u,`Initialization of query '${Te(t.query)}' failed`);return void t.onError(c)}e.queries.set(i,o),o.Sa.push(t),t.va(e.onlineState),o.wa&&t.Fa(o.wa)&&xs(e)}async function Za(r,t){const e=F(r),n=t.query;let i=3;const o=e.queries.get(n);if(o){const u=o.Sa.indexOf(t);u>=0&&(o.Sa.splice(u,1),o.Sa.length===0?i=t.Da()?0:1:!o.ba()&&t.Da()&&(i=2))}switch(i){case 0:return e.queries.delete(n),e.onUnlisten(n,!0);case 1:return e.queries.delete(n),e.onUnlisten(n,!1);case 2:return e.onLastRemoteStoreUnlisten(n);default:return}}function ef(r,t){const e=F(r);let n=!1;for(const i of t){const o=i.query,u=e.queries.get(o);if(u){for(const c of u.Sa)c.Fa(i)&&(n=!0);u.wa=i}}n&&xs(e)}function nf(r,t,e){const n=F(r),i=n.queries.get(t);if(i)for(const o of i.Sa)o.onError(e);n.queries.delete(t)}function xs(r){r.Ca.forEach(t=>{t.next()})}var us,No;(No=us||(us={})).Ma="default",No.Cache="cache";class tu{constructor(t,e,n){this.query=t,this.xa=e,this.Oa=!1,this.Na=null,this.onlineState="Unknown",this.options=n||{}}Fa(t){if(!this.options.includeMetadataChanges){const n=[];for(const i of t.docChanges)i.type!==3&&n.push(i);t=new be(t.query,t.docs,t.oldDocs,n,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let e=!1;return this.Oa?this.Ba(t)&&(this.xa.next(t),e=!0):this.La(t,this.onlineState)&&(this.ka(t),e=!0),this.Na=t,e}onError(t){this.xa.error(t)}va(t){this.onlineState=t;let e=!1;return this.Na&&!this.Oa&&this.La(this.Na,t)&&(this.ka(this.Na),e=!0),e}La(t,e){if(!t.fromCache||!this.Da())return!0;const n=e!=="Offline";return(!this.options.qa||!n)&&(!t.docs.isEmpty()||t.hasCachedResults||e==="Offline")}Ba(t){if(t.docChanges.length>0)return!0;const e=this.Na&&this.Na.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!e)&&this.options.includeMetadataChanges===!0}ka(t){t=be.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.Oa=!0,this.xa.next(t)}Da(){return this.options.source!==us.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eu{constructor(t){this.key=t}}class nu{constructor(t){this.key=t}}class rf{constructor(t,e){this.query=t,this.Ya=e,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=j(),this.mutatedKeys=j(),this.eu=ya(t),this.tu=new Ae(this.eu)}get nu(){return this.Ya}ru(t,e){const n=e?e.iu:new bo,i=e?e.tu:this.tu;let o=e?e.mutatedKeys:this.mutatedKeys,u=i,c=!1;const h=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,d=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(t.inorderTraversal((_,I)=>{const P=i.get(_),S=hr(this.query,I)?I:null,M=!!P&&this.mutatedKeys.has(P.key),k=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let b=!1;P&&S?P.data.isEqual(S.data)?M!==k&&(n.track({type:3,doc:S}),b=!0):this.su(P,S)||(n.track({type:2,doc:S}),b=!0,(h&&this.eu(S,h)>0||d&&this.eu(S,d)<0)&&(c=!0)):!P&&S?(n.track({type:0,doc:S}),b=!0):P&&!S&&(n.track({type:1,doc:P}),b=!0,(h||d)&&(c=!0)),b&&(S?(u=u.add(S),o=k?o.add(_):o.delete(_)):(u=u.delete(_),o=o.delete(_)))}),this.query.limit!==null)for(;u.size>this.query.limit;){const _=this.query.limitType==="F"?u.last():u.first();u=u.delete(_.key),o=o.delete(_.key),n.track({type:1,doc:_})}return{tu:u,iu:n,Cs:c,mutatedKeys:o}}su(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,i){const o=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const u=t.iu.ya();u.sort((_,I)=>function(S,M){const k=b=>{switch(b){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return O(20277,{Rt:b})}};return k(S)-k(M)}(_.type,I.type)||this.eu(_.doc,I.doc)),this.ou(n),i=i??!1;const c=e&&!i?this._u():[],h=this.Xa.size===0&&this.current&&!i?1:0,d=h!==this.Za;return this.Za=h,u.length!==0||d?{snapshot:new be(this.query,t.tu,o,u,t.mutatedKeys,h===0,d,!1,!!n&&n.resumeToken.approximateByteSize()>0),au:c}:{au:c}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new bo,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach(e=>this.Ya=this.Ya.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.Ya=this.Ya.delete(e)),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=j(),this.tu.forEach(n=>{this.uu(n.key)&&(this.Xa=this.Xa.add(n.key))});const e=[];return t.forEach(n=>{this.Xa.has(n)||e.push(new nu(n))}),this.Xa.forEach(n=>{t.has(n)||e.push(new eu(n))}),e}cu(t){this.Ya=t.Qs,this.Xa=j();const e=this.ru(t.documents);return this.applyChanges(e,!0)}lu(){return be.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Ms="SyncEngine";class sf{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class of{constructor(t){this.key=t,this.hu=!1}}class af{constructor(t,e,n,i,o,u){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=i,this.currentUser=o,this.maxConcurrentLimboResolutions=u,this.Pu={},this.Tu=new fe(c=>_a(c),cr),this.Iu=new Map,this.Eu=new Set,this.du=new Y(x.comparator),this.Au=new Map,this.Ru=new ws,this.Vu={},this.mu=new Map,this.fu=Ce.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function uf(r,t,e=!0){const n=uu(r);let i;const o=n.Tu.get(t);return o?(n.sharedClientState.addLocalQueryTarget(o.targetId),i=o.view.lu()):i=await ru(n,t,e,!0),i}async function lf(r,t){const e=uu(r);await ru(e,t,!0,!1)}async function ru(r,t,e,n){const i=await Sh(r.localStore,Ct(t)),o=i.targetId,u=r.sharedClientState.addLocalQueryTarget(o,e);let c;return n&&(c=await cf(r,t,o,u==="current",i.resumeToken)),r.isPrimaryClient&&e&&Ka(r.remoteStore,i),c}async function cf(r,t,e,n,i){r.pu=(I,P,S)=>async function(k,b,$,G){let Q=b.view.ru($);Q.Cs&&(Q=await wo(k.localStore,b.query,!1).then(({documents:E})=>b.view.ru(E,Q)));const ft=G&&G.targetChanges.get(b.targetId),It=G&&G.targetMismatches.get(b.targetId)!=null,nt=b.view.applyChanges(Q,k.isPrimaryClient,ft,It);return xo(k,b.targetId,nt.au),nt.snapshot}(r,I,P,S);const o=await wo(r.localStore,t,!0),u=new rf(t,o.Qs),c=u.ru(o.documents),h=yn.createSynthesizedTargetChangeForCurrentChange(e,n&&r.onlineState!=="Offline",i),d=u.applyChanges(c,r.isPrimaryClient,h);xo(r,e,d.au);const _=new sf(t,e,u);return r.Tu.set(t,_),r.Iu.has(e)?r.Iu.get(e).push(t):r.Iu.set(e,[t]),d.snapshot}async function hf(r,t,e){const n=F(r),i=n.Tu.get(t),o=n.Iu.get(i.targetId);if(o.length>1)return n.Iu.set(i.targetId,o.filter(u=>!cr(u,t))),void n.Tu.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(i.targetId),n.sharedClientState.isActiveQueryTarget(i.targetId)||await os(n.localStore,i.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(i.targetId),e&&Ss(n.remoteStore,i.targetId),ls(n,i.targetId)}).catch(Ne)):(ls(n,i.targetId),await os(n.localStore,i.targetId,!0))}async function ff(r,t){const e=F(r),n=e.Tu.get(t),i=e.Iu.get(n.targetId);e.isPrimaryClient&&i.length===1&&(e.sharedClientState.removeLocalQueryTarget(n.targetId),Ss(e.remoteStore,n.targetId))}async function df(r,t,e){const n=Tf(r);try{const i=await function(u,c){const h=F(u),d=H.now(),_=c.reduce((S,M)=>S.add(M.key),j());let I,P;return h.persistence.runTransaction("Locally write mutations","readwrite",S=>{let M=Ft(),k=j();return h.Ns.getEntries(S,_).next(b=>{M=b,M.forEach(($,G)=>{G.isValidDocument()||(k=k.add($))})}).next(()=>h.localDocuments.getOverlayedDocuments(S,M)).next(b=>{I=b;const $=[];for(const G of c){const Q=Vc(G,I.get(G.key).overlayedDocument);Q!=null&&$.push(new de(G.key,Q,ca(Q.value.mapValue),Ot.exists(!0)))}return h.mutationQueue.addMutationBatch(S,d,$,c)}).next(b=>{P=b;const $=b.applyToLocalDocumentSet(I,k);return h.documentOverlayCache.saveOverlays(S,b.batchId,$)})}).then(()=>({batchId:P.batchId,changes:Ta(I)}))}(n.localStore,t);n.sharedClientState.addPendingMutation(i.batchId),function(u,c,h){let d=u.Vu[u.currentUser.toKey()];d||(d=new Y(q)),d=d.insert(c,h),u.Vu[u.currentUser.toKey()]=d}(n,i.batchId,e),await Tn(n,i.changes),await _r(n.remoteStore)}catch(i){const o=ks(i,"Failed to persist write");e.reject(o)}}async function su(r,t){const e=F(r);try{const n=await Rh(e.localStore,t);t.targetChanges.forEach((i,o)=>{const u=e.Au.get(o);u&&(z(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1,22616),i.addedDocuments.size>0?u.hu=!0:i.modifiedDocuments.size>0?z(u.hu,14607):i.removedDocuments.size>0&&(z(u.hu,42227),u.hu=!1))}),await Tn(e,n,t)}catch(n){await Ne(n)}}function ko(r,t,e){const n=F(r);if(n.isPrimaryClient&&e===0||!n.isPrimaryClient&&e===1){const i=[];n.Tu.forEach((o,u)=>{const c=u.view.va(t);c.snapshot&&i.push(c.snapshot)}),function(u,c){const h=F(u);h.onlineState=c;let d=!1;h.queries.forEach((_,I)=>{for(const P of I.Sa)P.va(c)&&(d=!0)}),d&&xs(h)}(n.eventManager,t),i.length&&n.Pu.H_(i),n.onlineState=t,n.isPrimaryClient&&n.sharedClientState.setOnlineState(t)}}async function mf(r,t,e){const n=F(r);n.sharedClientState.updateQueryState(t,"rejected",e);const i=n.Au.get(t),o=i&&i.key;if(o){let u=new Y(x.comparator);u=u.insert(o,pt.newNoDocument(o,L.min()));const c=j().add(o),h=new mr(L.min(),new Map,new Y(q),u,c);await su(n,h),n.du=n.du.remove(o),n.Au.delete(t),Os(n)}else await os(n.localStore,t,!1).then(()=>ls(n,t,e)).catch(Ne)}async function gf(r,t){const e=F(r),n=t.batch.batchId;try{const i=await wh(e.localStore,t);ou(e,n,null),iu(e,n),e.sharedClientState.updateMutationState(n,"acknowledged"),await Tn(e,i)}catch(i){await Ne(i)}}async function pf(r,t,e){const n=F(r);try{const i=await function(u,c){const h=F(u);return h.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let _;return h.mutationQueue.lookupMutationBatch(d,c).next(I=>(z(I!==null,37113),_=I.keys(),h.mutationQueue.removeMutationBatch(d,I))).next(()=>h.mutationQueue.performConsistencyCheck(d)).next(()=>h.documentOverlayCache.removeOverlaysForBatchId(d,_,c)).next(()=>h.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,_)).next(()=>h.localDocuments.getDocuments(d,_))})}(n.localStore,t);ou(n,t,e),iu(n,t),n.sharedClientState.updateMutationState(t,"rejected",e),await Tn(n,i)}catch(i){await Ne(i)}}function iu(r,t){(r.mu.get(t)||[]).forEach(e=>{e.resolve()}),r.mu.delete(t)}function ou(r,t,e){const n=F(r);let i=n.Vu[n.currentUser.toKey()];if(i){const o=i.get(t);o&&(e?o.reject(e):o.resolve(),i=i.remove(t)),n.Vu[n.currentUser.toKey()]=i}}function ls(r,t,e=null){r.sharedClientState.removeLocalQueryTarget(t);for(const n of r.Iu.get(t))r.Tu.delete(n),e&&r.Pu.yu(n,e);r.Iu.delete(t),r.isPrimaryClient&&r.Ru.jr(t).forEach(n=>{r.Ru.containsKey(n)||au(r,n)})}function au(r,t){r.Eu.delete(t.path.canonicalString());const e=r.du.get(t);e!==null&&(Ss(r.remoteStore,e),r.du=r.du.remove(t),r.Au.delete(e),Os(r))}function xo(r,t,e){for(const n of e)n instanceof eu?(r.Ru.addReference(n.key,t),_f(r,n)):n instanceof nu?(D(Ms,"Document no longer in limbo: "+n.key),r.Ru.removeReference(n.key,t),r.Ru.containsKey(n.key)||au(r,n.key)):O(19791,{wu:n})}function _f(r,t){const e=t.key,n=e.path.canonicalString();r.du.get(e)||r.Eu.has(n)||(D(Ms,"New document in limbo: "+e),r.Eu.add(n),Os(r))}function Os(r){for(;r.Eu.size>0&&r.du.size<r.maxConcurrentLimboResolutions;){const t=r.Eu.values().next().value;r.Eu.delete(t);const e=new x(X.fromString(t)),n=r.fu.next();r.Au.set(n,new of(e)),r.du=r.du.insert(e,n),Ka(r.remoteStore,new Gt(Ct(lr(e.path)),n,"TargetPurposeLimboResolution",ir.ce))}}async function Tn(r,t,e){const n=F(r),i=[],o=[],u=[];n.Tu.isEmpty()||(n.Tu.forEach((c,h)=>{u.push(n.pu(h,t,e).then(d=>{var _;if((d||e)&&n.isPrimaryClient){const I=d?!d.fromCache:(_=e==null?void 0:e.targetChanges.get(h.targetId))==null?void 0:_.current;n.sharedClientState.updateQueryState(h.targetId,I?"current":"not-current")}if(d){i.push(d);const I=Ps.As(h.targetId,d);o.push(I)}}))}),await Promise.all(u),n.Pu.H_(i),await async function(h,d){const _=F(h);try{await _.persistence.runTransaction("notifyLocalViewChanges","readwrite",I=>R.forEach(d,P=>R.forEach(P.Es,S=>_.persistence.referenceDelegate.addReference(I,P.targetId,S)).next(()=>R.forEach(P.ds,S=>_.persistence.referenceDelegate.removeReference(I,P.targetId,S)))))}catch(I){if(!ke(I))throw I;D(Vs,"Failed to update sequence numbers: "+I)}for(const I of d){const P=I.targetId;if(!I.fromCache){const S=_.Ms.get(P),M=S.snapshotVersion,k=S.withLastLimboFreeSnapshotVersion(M);_.Ms=_.Ms.insert(P,k)}}}(n.localStore,o))}async function yf(r,t){const e=F(r);if(!e.currentUser.isEqual(t)){D(Ms,"User change. New user:",t.toKey());const n=await Ba(e.localStore,t);e.currentUser=t,function(o,u){o.mu.forEach(c=>{c.forEach(h=>{h.reject(new N(V.CANCELLED,u))})}),o.mu.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await Tn(e,n.Ls)}}function Ef(r,t){const e=F(r),n=e.Au.get(t);if(n&&n.hu)return j().add(n.key);{let i=j();const o=e.Iu.get(t);if(!o)return i;for(const u of o){const c=e.Tu.get(u);i=i.unionWith(c.view.nu)}return i}}function uu(r){const t=F(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=su.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=Ef.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=mf.bind(null,t),t.Pu.H_=ef.bind(null,t.eventManager),t.Pu.yu=nf.bind(null,t.eventManager),t}function Tf(r){const t=F(r);return t.remoteStore.remoteSyncer.applySuccessfulWrite=gf.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=pf.bind(null,t),t}class rr{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=gr(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,e){return null}Mu(t,e){return null}vu(t){return Ah(this.persistence,new Th,t.initialUser,this.serializer)}Cu(t){return new ja(Rs.mi,this.serializer)}Du(t){return new bh}async terminate(){var t,e;(t=this.gcScheduler)==null||t.stop(),(e=this.indexBackfillerScheduler)==null||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}rr.provider={build:()=>new rr};class If extends rr{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,e){z(this.persistence.referenceDelegate instanceof er,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new ih(n,t.asyncQueue,e)}Cu(t){const e=this.cacheSizeBytes!==void 0?Tt.withCacheSize(this.cacheSizeBytes):Tt.DEFAULT;return new ja(n=>er.mi(n,e),this.serializer)}}class cs{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>ko(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=yf.bind(null,this.syncEngine),await Jh(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new tf}()}createDatastore(t){const e=gr(t.databaseInfo.databaseId),n=function(o){return new Mh(o)}(t.databaseInfo);return function(o,u,c,h){return new Uh(o,u,c,h)}(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return function(n,i,o,u,c){return new jh(n,i,o,u,c)}(this.localStore,this.datastore,t.asyncQueue,e=>ko(this.syncEngine,e,0),function(){return Vo.v()?new Vo:new Dh}())}createSyncEngine(t,e){return function(i,o,u,c,h,d,_){const I=new af(i,o,u,c,h,d);return _&&(I.gu=!0),I}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(i){const o=F(i);D(ce,"RemoteStore shutting down."),o.Ea.add(5),await En(o),o.Aa.shutdown(),o.Ra.set("Unknown")}(this.remoteStore),(t=this.datastore)==null||t.terminate(),(e=this.eventManager)==null||e.terminate()}}cs.provider={build:()=>new cs};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lu{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ou(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ou(this.observer.error,t):Lt("Uncaught Error in snapshot listener:",t.toString()))}Nu(){this.muted=!0}Ou(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bo(r){return function(e,n){if(typeof e!="object"||e===null)return!1;const i=e;for(const o of n)if(o in i&&typeof i[o]=="function")return!0;return!1}(r,["next","error","complete"])}class gn extends Ls{constructor(t,e,n,i){super(t,e,n,i),this.type="firestore",this._queue=new qo,this._persistenceKey=(i==null?void 0:i.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new qo(t),this._firestoreClient=void 0,await t}}}function Vf(r,t){const e=typeof r=="object"?r:hl(),n=typeof r=="string"?r:t,i=fl(e,"firestore").getImmediate({identifier:n});if(!i._initialized){const o=dl("firestore");o&&Pf(i,...o)}return i}function Fs(r){if(r._terminated)throw new N(V.FAILED_PRECONDITION,"The client has already been terminated.");return r._firestoreClient||Sf(r),r._firestoreClient}function Sf(r){var n,i,o;const t=r._freezeSettings(),e=function(c,h,d,_){return new Xl(c,h,d,_.host,_.ssl,_.experimentalForceLongPolling,_.experimentalAutoDetectLongPolling,hu(_.experimentalLongPollingOptions),_.useFetchStreams,_.isUsingEmulator)}(r._databaseId,((n=r._app)==null?void 0:n.options.appId)||"",r._persistenceKey,t);r._componentsProvider||(i=t.localCache)!=null&&i._offlineComponentProvider&&((o=t.localCache)!=null&&o._onlineComponentProvider)&&(r._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),r._firestoreClient=new vf(r._authCredentials,r._appCheckCredentials,r._queue,e,r._componentsProvider&&function(c){const h=c==null?void 0:c._online.build();return{_offline:c==null?void 0:c._offline.build(h),_online:h}}(r._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Us{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new N(V.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ct(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cf=/^__.*__$/;class bf{constructor(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}toMutation(t,e){return this.fieldMask!==null?new de(t,this.data,this.fieldMask,e,this.fieldTransforms):new _n(t,this.data,e,this.fieldTransforms)}}function mu(r){switch(r){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw O(40011,{Ac:r})}}class js{constructor(t,e,n,i,o,u){this.settings=t,this.databaseId=e,this.serializer=n,this.ignoreUndefinedProperties=i,o===void 0&&this.Rc(),this.fieldTransforms=o||[],this.fieldMask=u||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(t){return new js({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(t){var i;const e=(i=this.path)==null?void 0:i.child(t),n=this.Vc({path:e,fc:!1});return n.gc(t),n}yc(t){var i;const e=(i=this.path)==null?void 0:i.child(t),n=this.Vc({path:e,fc:!1});return n.Rc(),n}wc(t){return this.Vc({path:void 0,fc:!0})}Sc(t){return sr(t,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}Rc(){if(this.path)for(let t=0;t<this.path.length;t++)this.gc(this.path.get(t))}gc(t){if(t.length===0)throw this.Sc("Document fields must not be empty");if(mu(this.Ac)&&Cf.test(t))throw this.Sc('Document fields cannot begin and end with "__"')}}class Df{constructor(t,e,n){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=n||gr(t)}Cc(t,e,n,i=!1){return new js({Ac:t,methodName:e,Dc:n,path:ct.emptyPath(),fc:!1,bc:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Nf(r){const t=r._freezeSettings(),e=gr(r._databaseId);return new Df(r._databaseId,!!t.ignoreUndefinedProperties,e)}function kf(r,t,e,n,i,o={}){const u=r.Cc(o.merge||o.mergeFields?2:0,t,e,i);yu("Data must be an object, but it was:",u,n);const c=pu(n,u);let h,d;if(o.merge)h=new Rt(u.fieldMask),d=u.fieldTransforms;else if(o.mergeFields){const _=[];for(const I of o.mergeFields){const P=xf(t,I,e);if(!u.contains(P))throw new N(V.INVALID_ARGUMENT,`Field '${P}' is specified in your field mask but missing from your input data.`);Of(_,P)||_.push(P)}h=new Rt(_),d=u.fieldTransforms.filter(I=>h.covers(I.field))}else h=null,d=u.fieldTransforms;return new bf(new At(c),h,d)}class Bs extends qs{_toFieldTransform(t){return new Ac(t.path,new hn)}isEqual(t){return t instanceof Bs}}function gu(r,t){if(_u(r=on(r)))return yu("Unsupported field value:",t,r),pu(r,t);if(r instanceof qs)return function(n,i){if(!mu(i.Ac))throw i.Sc(`${n._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Sc(`${n._methodName}() is not currently supported inside arrays`);const o=n._toFieldTransform(i);o&&i.fieldTransforms.push(o)}(r,t),null;if(r===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),r instanceof Array){if(t.settings.fc&&t.Ac!==4)throw t.Sc("Nested arrays are not supported");return function(n,i){const o=[];let u=0;for(const c of n){let h=gu(c,i.wc(u));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),u++}return{arrayValue:{values:o}}}(r,t)}return function(n,i){if((n=on(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return Tc(i.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const o=H.fromDate(n);return{timestampValue:tr(i.serializer,o)}}if(n instanceof H){const o=new H(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:tr(i.serializer,o)}}if(n instanceof Dt)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof wt)return{bytesValue:ka(i.serializer,n._byteString)};if(n instanceof it){const o=i.databaseId,u=n.firestore._databaseId;if(!u.isEqual(o))throw i.Sc(`Document reference is for database ${u.projectId}/${u.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:As(n.firestore._databaseId||i.databaseId,n._key.path)}}if(n instanceof Nt)return function(u,c){return{mapValue:{fields:{[ua]:{stringValue:la},[Xn]:{arrayValue:{values:u.toArray().map(d=>{if(typeof d!="number")throw c.Sc("VectorValues must only contain numeric values.");return Ts(c.serializer,d)})}}}}}}(n,i);throw i.Sc(`Unsupported field value: ${ms(n)}`)}(r,t)}function pu(r,t){const e={};return na(r)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):he(r,(n,i)=>{const o=gu(i,t.mc(n));o!=null&&(e[n]=o)}),{mapValue:{fields:e}}}function _u(r){return!(typeof r!="object"||r===null||r instanceof Array||r instanceof Date||r instanceof H||r instanceof Dt||r instanceof wt||r instanceof it||r instanceof qs||r instanceof Nt)}function yu(r,t,e){if(!_u(e)||!ta(e)){const n=ms(e);throw n==="an object"?t.Sc(r+" a custom object"):t.Sc(r+" "+n)}}function xf(r,t,e){if((t=on(t))instanceof Us)return t._internalPath;if(typeof t=="string")return Eu(r,t);throw sr("Field path arguments must be of type string or ",r,!1,void 0,e)}const Mf=new RegExp("[~\\*/\\[\\]]");function Eu(r,t,e){if(t.search(Mf)>=0)throw sr(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,r,!1,void 0,e);try{return new Us(...t.split("."))._internalPath}catch{throw sr(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r,!1,void 0,e)}}function sr(r,t,e,n,i){const o=n&&!n.isEmpty(),u=i!==void 0;let c=`Function ${t}() called with invalid data`;e&&(c+=" (via `toFirestore()`)"),c+=". ";let h="";return(o||u)&&(h+=" (found",o&&(h+=` in field ${n}`),u&&(h+=` in document ${i}`),h+=")"),new N(V.INVALID_ARGUMENT,c+r+h)}function Of(r,t){return r.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bf(r){r=Wt(r,it);const t=Wt(r.firestore,gn);return Rf(Fs(t),r._key).then(e=>Au(t,r,e))}we._jsonSchemaVersion="firestore/querySnapshot/1.0",we._jsonSchema={type:et("string",we._jsonSchemaVersion),bundleSource:et("string","QuerySnapshot"),bundleName:et("string"),bundle:et("string")};class vu extends Uf{constructor(t){super(),this.firestore=t}convertBytes(t){return new wt(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new it(this.firestore,null,e)}}function zf(r,t,e){r=Wt(r,it);const n=Wt(r.firestore,gn),i=qf(r.converter,t);return Gf(n,[kf(Nf(n),"setDoc",r._key,i,r.converter!==null,e).toMutation(r._key,Ot.none())])}function $f(r,...t){var h,d,_;r=on(r);let e={includeMetadataChanges:!1,source:"default"},n=0;typeof t[n]!="object"||Bo(t[n])||(e=t[n++]);const i={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Bo(t[n])){const I=t[n];t[n]=(h=I.next)==null?void 0:h.bind(I),t[n+1]=(d=I.error)==null?void 0:d.bind(I),t[n+2]=(_=I.complete)==null?void 0:_.bind(I)}let o,u,c;if(r instanceof it)u=Wt(r.firestore,gn),c=lr(r._key.path),o={next:I=>{t[n]&&t[n](Au(u,r,I))},error:t[n+1],complete:t[n+2]};else{const I=Wt(r,yr);u=Wt(I.firestore,gn),c=I._query;const P=new vu(u);o={next:S=>{t[n]&&t[n](new we(u,P,I,S))},error:t[n+1],complete:t[n+2]},Ff(r._query)}return function(P,S,M,k){const b=new lu(k),$=new tu(S,b,M);return P.asyncQueue.enqueueAndForget(async()=>Ja(await hs(P),$)),()=>{b.Nu(),P.asyncQueue.enqueueAndForget(async()=>Za(await hs(P),$))}}(Fs(u),c,i,o)}function Gf(r,t){return function(n,i){const o=new Qt;return n.asyncQueue.enqueueAndForget(async()=>df(await wf(n),i,o)),o.promise}(Fs(r),t)}function Au(r,t,e){const n=e.docs.get(t._key),i=new vu(r);return new ue(r,i,t._key,n,new tn(e.hasPendingWrites,e.fromCache),t.converter)}function Kf(){return new Bs("serverTimestamp")}(function(t,e=!0){(function(i){De=i})(Tl),al(new ul("firestore",(n,{instanceIdentifier:i,options:o})=>{const u=n.getProvider("app").getImmediate(),c=new gn(new bl(n.getProvider("auth-internal")),new kl(u,n.getProvider("app-check-internal")),function(d,_){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new N(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ln(d.options.projectId,_)}(u,i),u);return o={useFetchStreams:e,...o},c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),Gi(Qi,Wi,t),Gi(Qi,Wi,"esm2020")})();const Qf={apiKey:"AIzaSyDMjzdCgNbI9W8pUd6AJoGRQlYDqKNcf_c",authDomain:"wise-catty.cc",projectId:"wisecat-8df8d",storageBucket:"wisecat-8df8d.firebasestorage.app",messagingSenderId:"1078479155773",appId:"1:1078479155773:web:cd62907516951aa47db054",measurementId:"G-30M228G3VP"},wu=Il(Qf),zs=vl(wu),Wn=Vf(wu,"reservation");window.firebaseInitialized=!0;const Wf=new Al,Hf=new wl("microsoft.com");let jn=null;document.addEventListener("DOMContentLoaded",()=>{il.init();const r=document.getElementById("googleLoginBtn"),t=document.getElementById("microsoftLoginBtn"),e=document.getElementById("lineLoginBtn");r&&r.addEventListener("click",()=>zo(Wf)),t&&t.addEventListener("click",()=>zo(Hf)),e&&e.addEventListener("click",Xf),window.logout=$o;const n=document.querySelector(".logout-btn");n&&n.addEventListener("click",$o)});async function zo(r){var e;const t=document.getElementById("authError");t&&(t.textContent="");try{const i=(await Rl(zs,r)).user;console.log("Social login success:",i.uid);const o=`uid_${i.uid}`,u=du(Wn,"users",o);if(console.log(`Connecting to DB: ${Wn.app.options.projectId}, DB ID: ${((e=Wn._databaseId)==null?void 0:e.database)||"default"}`),!(await Bf(u)).exists()){const h={name:i.displayName||"WiseCat User",email:i.email||"N/A",uid:i.uid,picture:i.photoURL||"https://ui-avatars.com/api/?name="+encodeURIComponent(i.email||"User"),credits:1,createdAt:Kf()};await zf(u,h),console.log("New user document created with $1.00 bonus:",o)}}catch(n){console.error("Social login error:",n),t&&(t.textContent="Auth error: "+n.message)}}function Xf(){const r="2008812650",t=encodeURIComponent("https://wise-catty.cc/api/auth/line/callback"),e="random_string_for_security_"+Date.now(),i=`https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=${r}&redirect_uri=${t}&state=${e}&scope=openid%20profile%20email`;window.location.href=i}function $o(){Pl(zs).then(()=>{console.log("User signed out."),localStorage.removeItem("wisecat_user")}).catch(r=>{console.error("Sign out error",r)})}Vl(zs,r=>{if(jn&&(jn(),jn=null),r){const t=`uid_${r.uid}`,e=du(Wn,"users",t);jn=$f(e,n=>{if(n.exists()){const i=n.data(),o={name:i.name||r.displayName||(r.email?r.email.split("@")[0]:"User"),email:r.email||"N/A",picture:i.picture||r.photoURL||"https://ui-avatars.com/api/?name="+encodeURIComponent(r.email||"User"),sub:r.uid,credits:i.credits||0};localStorage.setItem("wisecat_user",JSON.stringify(o)),Yf(o)}},n=>{console.error("Firestore snapshot error:",n)})}else{localStorage.removeItem("wisecat_user");const t=document.getElementById("loginPrompt"),e=document.getElementById("userProfile"),n=document.getElementById("creditsAmount");t&&t.classList.remove("hide"),e&&e.classList.remove("show"),n&&(n.textContent="$0.00 USD")}});function Yf(r){const t=document.getElementById("loginPrompt"),e=document.getElementById("userProfile");t&&t.classList.add("hide"),e&&e.classList.add("show");const n=document.getElementById("userName"),i=document.getElementById("userEmail"),o=document.getElementById("userAvatar"),u=document.getElementById("creditsAmount");n&&(n.textContent=r.name),i&&(i.textContent=r.email),o&&(o.src=r.picture),u&&(u.textContent=`$${(r.credits||0).toFixed(2)} USD`,window.dispatchEvent(new Event("userUpdated")))}function Jf(){const r=document.getElementById("bg-canvas");if(!r)return;const t=r.getContext("2d");if(!t)return;let e,n,i=[];const o=50;function u(){e=window.innerWidth,n=window.innerHeight,r.width=e,r.height=n}window.addEventListener("resize",u),u();class c{constructor(){ye(this,"x");ye(this,"y");ye(this,"vx");ye(this,"vy");ye(this,"size");this.x=Math.random()*e,this.y=Math.random()*n,this.vx=(Math.random()-.5)*.3,this.vy=(Math.random()-.5)*.3,this.size=Math.random()*2+1}update(){this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>e)&&(this.vx*=-1),(this.y<0||this.y>n)&&(this.vy*=-1)}draw(){t&&(t.fillStyle="rgba(0, 185, 0, 0.3)",t.beginPath(),t.arc(this.x,this.y,this.size,0,Math.PI*2),t.fill())}}for(let d=0;d<o;d++)i.push(new c);function h(){t&&(t.clearRect(0,0,e,n),i.forEach(d=>{d.update(),d.draw()}),requestAnimationFrame(h))}h()}document.addEventListener("DOMContentLoaded",Jf);
