import{_ as Pe,C as xe,r as se,S as Se,h as Le,F as Fe,i as Me,j as q,k as $e,l as He,m as fe,p as qe,u as je,n as ze,q as Ve,t as We,v as Ke,e as Xe,w as Ge,x as pe,o as Ye,y as Ze,d as Je,z as Qe,a as et}from"./index.esm-Drz8edDF.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class R{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=R.makeFromUrl(t,n)}catch{return new R(t,"")}if(s.path==="")return s;throw dt(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function o(b){b.path.charAt(b.path.length-1)==="/"&&(b.path_=b.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+r+i,"i"),c={bucket:1,path:3};function l(b){b.path_=decodeURIComponent(b.path)}const h="v[A-Za-z0-9_]+",_=n.replace(/[.]/g,"\\."),p="(/([^?#]*).*)?$",y=new RegExp(`^https?://${_}/${h}/b/${r}/o${p}`,"i"),w={bucket:1,path:3},f=n===me?"(?:storage.googleapis.com|storage.cloud.google.com)":n,g="([^?#]*)",O=new RegExp(`^https?://${f}/${r}/${g}`,"i"),k=[{regex:a,indices:c,postModify:o},{regex:y,indices:w,postModify:l},{regex:O,indices:{bucket:1,path:2},postModify:l}];for(let b=0;b<k.length;b++){const P=k[b],j=P.regex.exec(t);if(j){const ve=j[P.indices.bucket];let z=j[P.indices.path];z||(z=""),s=new R(ve,z),P.postModify(s);break}}if(s==null)throw ut(t);return s}}class gt{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function c(){return a===2}let l=!1;function h(...g){l||(l=!0,t.apply(null,g))}function _(g){r=setTimeout(()=>{r=null,e(y,c())},g)}function p(){o&&clearTimeout(o)}function y(g,...O){if(l){p();return}if(g){p(),h.call(null,g,...O);return}if(c()||i){p(),h.call(null,g,...O);return}s<64&&(s*=2);let k;a===1?(a=2,k=0):k=(s+Math.random())*1e3,_(k)}let w=!1;function f(g){w||(w=!0,p(),!l&&(r!==null?(g||(a=2),clearTimeout(r),_(0)):g||(a=1)))}return _(0),o=setTimeout(()=>{i=!0,f(!0)},n),f}function yt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{constructor(t,n,s,r,o,i,a,c,l,h,_,p=!0,y=!1){this.url_=t,this.method_=n,this.headers_=s,this.body_=r,this.successCodes_=o,this.additionalRetryCodes_=i,this.callback_=a,this.errorCallback_=c,this.timeout_=l,this.progressCallback_=h,this.connectionFactory_=_,this.retry=p,this.isUsingEmulator=y,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((w,f)=>{this.resolve_=w,this.reject_=f,this.start_()})}start_(){const t=(s,r)=>{if(r){s(!1,new x(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const i=a=>{const c=a.loaded,l=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,l)};this.progressCallback_!==null&&o.addUploadProgressListener(i),o.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(i),this.pendingConnection_=null;const a=o.getErrorCode()===U.NO_ERROR,c=o.getStatus();if(!a||Tt(c,this.additionalRetryCodes_)&&this.retry){const h=o.getErrorCode()===U.ABORT;s(!1,new x(!1,null,h));return}const l=this.successCodes_.indexOf(c)!==-1;s(!0,new x(l,o))})},n=(s,r)=>{const o=this.resolve_,i=this.reject_,a=r.connection;if(r.wasSuccessCode)try{const c=this.callback_(a,a.getResponse());wt(c)?o(c):o()}catch(c){i(c)}else if(a!==null){const c=G();c.serverResponse=a.getErrorText(),this.errorCallback_?i(this.errorCallback_(a,c)):i(c)}else if(r.canceled){const c=this.appDelete_?ge():lt();i(c)}else{const c=ct();i(c)}};this.canceled_?n(!1,new x(!1,null,!0)):this.backoffId_=bt(t,n,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,this.backoffId_!==null&&yt(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class x{constructor(t,n,s){this.wasSuccessCode=t,this.connection=n,this.canceled=!!s}}function Et(e,t){t!==null&&t.length>0&&(e.Authorization="Firebase "+t)}function At(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}function It(e,t){t&&(e["X-Firebase-GMPID"]=t)}function Ut(e,t){t!==null&&(e["X-Firebase-AppCheck"]=t)}function Ct(e,t,n,s,r,o,i=!0,a=!1){const c=be(e.urlParams),l=e.url+c,h=Object.assign({},e.headers);return It(h,t),Et(h,n),At(h,o),Ut(h,s),new kt(l,e.method,h,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r,i,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bt(e){if(typeof atob>"u")throw mt("base-64");return atob(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class W{constructor(t,n){this.data=t,this.contentType=n||null}}function vt(e,t){switch(e){case E.RAW:return new W(ye(t));case E.BASE64:case E.BASE64URL:return new W(we(e,t));case E.DATA_URL:return new W(xt(t),St(t))}throw G()}function ye(e){const t=[];for(let n=0;n<e.length;n++){let s=e.charCodeAt(n);if(s<=127)t.push(s);else if(s<=2047)t.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<e.length-1&&(e.charCodeAt(n+1)&64512)===56320))t.push(239,191,189);else{const o=s,i=e.charCodeAt(++n);s=65536|(o&1023)<<10|i&1023,t.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?t.push(239,191,189):t.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(t)}function Pt(e){let t;try{t=decodeURIComponent(e)}catch{throw B(E.DATA_URL,"Malformed data URL.")}return ye(t)}function we(e,t){switch(e){case E.BASE64:{const r=t.indexOf("-")!==-1,o=t.indexOf("_")!==-1;if(r||o)throw B(e,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case E.BASE64URL:{const r=t.indexOf("+")!==-1,o=t.indexOf("/")!==-1;if(r||o)throw B(e,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Bt(t)}catch(r){throw r.message.includes("polyfill")?r:B(e,"Invalid character found")}const s=new Uint8Array(n.length);for(let r=0;r<n.length;r++)s[r]=n.charCodeAt(r);return s}class Re{constructor(t){this.base64=!1,this.contentType=null;const n=t.match(/^data:([^,]+)?,/);if(n===null)throw B(E.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=Lt(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=t.substring(t.indexOf(",")+1)}}function xt(e){const t=new Re(e);return t.base64?we(E.BASE64,t.rest):Pt(t.rest)}function St(e){return new Re(e).contentType}function Lt(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class C{constructor(t,n){this._service=t,n instanceof R?this._location=n:this._location=R.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new C(t,n)}get root(){const t=new R(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return ke(this._location.path)}get storage(){return this._service}get parent(){const t=Ft(this._location.path);if(t===null)return null;const n=new R(this._location.bucket,t);return new C(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw _t(t)}}function tn(e,t,n){e._throwIfRoot("uploadBytes");const s=Jt(e.storage,e._location,Ee(),new A(t,!0),n);return e.storage.makeRequestWithTokens(s,Oe).then(r=>({metadata:r,ref:e}))}function nn(e){e._throwIfRoot("getDownloadURL");const t=Gt(e.storage,e._location,Ee());return e.storage.makeRequestWithTokens(t,Oe).then(n=>{if(n===null)throw pt();return n})}function sn(e,t){const n=Mt(e._location.path,t),s=new R(e._location.bucket,n);return new C(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De="storage";function ln(e,t,n){return e=q(e),tn(e,t,n)}function un(e){return e=q(e),nn(e)}function dn(e,t){return e=q(e),an(e,t)}function hn(e=Me(),t){e=q(e);const s=$e(e,De).getImmediate({identifier:t}),r=He("storage");return r&&fn(s,...r),s}function fn(e,t,n,s={}){cn(e,t,n,s)}function pn(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new Q(n,s,r,t,Se)}function mn(){Pe(new xe(De,pn,"PUBLIC").setMultipleInstances(!0)),se(ae,ce,""),se(ae,ce,"esm2020")}mn();const _n={apiKey:"AIzaSyDMjzdCgNbI9W8pUd6AJoGRQlYDqKNcf_c",authDomain:"wise-catty.cc",projectId:"wisecat-8df8d",storageBucket:"wisecat-8df8d.firebasestorage.app",messagingSenderId:"1078479155773",appId:"1:1078479155773:web:cd62907516951aa47db054",measurementId:"G-30M228G3VP"},ee=Ve(_n),gn=We(ee),te=Ke(ee,"reservation"),bn=hn(ee),le=document.getElementById("authCheck"),L=document.getElementById("mainContent"),F=document.getElementById("loginContent"),M=document.getElementById("taskTableBody"),ne=document.getElementById("taskModal"),ue=document.getElementById("newTaskBtn"),de=document.getElementById("cancelBtn"),H=document.getElementById("taskForm"),yn=document.getElementById("titleInput"),wn=document.getElementById("priorityInput"),Rn=document.getElementById("descInput"),he=document.getElementById("fileInput"),$=document.getElementById("submitBtn");let N=null,v=[],T={field:"priority",dir:"desc"};Xe(gn,e=>{le&&(le.hidden=!0),e?(N=e,L&&(L.hidden=!1),F&&(F.hidden=!0),Tn()):(N=null,L&&(L.hidden=!0),F&&(F.hidden=!1))});function Tn(){const e=Ge(pe(te,"dev_task"));Ye(e,t=>{v=[],t.forEach(n=>{v.push({id:n.id,...n.data()})}),Be()})}function Be(){if(M){if(M.innerHTML="",v.length===0){M.innerHTML='<tr><td colspan="7" style="text-align:center; padding: 2rem; color: #64748b;">No tasks found. Create one!</td></tr>';return}v.sort((e,t)=>{var r,o;let n=e[T.field],s=t[T.field];return T.field==="createdBy"&&(n=((r=e.createdBy)==null?void 0:r.name)||"",s=((o=t.createdBy)==null?void 0:o.name)||""),n<s?T.dir==="asc"?-1:1:n>s?T.dir==="asc"?1:-1:0}),v.forEach(e=>{var _,p,y,w;const t=document.createElement("tr"),n=`p-${e.priority||3}`,s=e.priority||3,r=e.completed===!0,o=r?'<span class="status-badge status-done">● Done</span>':'<span class="status-badge status-pending">○ Pending</span>',i=K(e.title||"(No Title)"),a=K((e.content||"").substring(0,60)+(((_=e.content)==null?void 0:_.length)>60?"...":"")),c=K(((p=e.createdBy)==null?void 0:p.name)||((y=e.createdBy)==null?void 0:y.email)||"Unknown");let l="-";if(e.createdAt){const f=e.createdAt.toDate?e.createdAt.toDate():new Date(e.createdAt);l=f.toLocaleDateString()+" "+f.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}let h="";if(e.attachment_url&&(h=`<br><a href="${e.attachment_url}" target="_blank" style="font-size: 0.8em; color: var(--accent);">📎 View Attachment</a>`),t.innerHTML=`
            <td><span class="priority-badge ${n}">P${s}</span></td>
            <td style="font-weight: 500;">
                ${i}
                ${h}
            </td>
            <td style="color: #94a3b8; font-size: 0.9em;">${a}</td>
            <td style="font-size: 0.85em; color: #ccc;">${l}</td>
            <td style="font-size: 0.9em;">${c}</td>
            <td>${o}</td>
            <td class="action-cell"></td>
        `,!r){const f=document.createElement("button");f.textContent="🗑️",f.style.background="transparent",f.style.border="none",f.style.cursor="pointer",f.style.fontSize="1.2rem",f.title="Delete Task",f.onclick=()=>En(e.id),(w=t.querySelector(".action-cell"))==null||w.appendChild(f)}M.appendChild(t)})}}document.querySelectorAll("th[data-sort]").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-sort");t&&(T.field===t?T.dir=T.dir==="asc"?"desc":"asc":(T.field=t,T.dir="desc"),Be(),kn())})});function kn(){document.querySelectorAll("th[data-sort]").forEach(e=>{var s;const t=e.getAttribute("data-sort");let n=((s=e.textContent)==null?void 0:s.replace(/[↕↑↓]/g,"").trim())||"";T.field===t?(e.textContent=`${n} ${T.dir==="asc"?"↑":"↓"}`,e.style.color="var(--accent)"):(e.textContent=`${n} ↕`,e.style.color="")})}async function En(e){if(confirm("Are you sure you want to delete this task? This cannot be undone."))try{await Ze(Je(te,"dev_task",e))}catch(t){console.error("Error deleting task:",t),alert("Failed to delete task. Check console for details.")}}function K(e){return e?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}ue&&ue.addEventListener("click",()=>{ne.showModal()});de&&de.addEventListener("click",()=>{ne.close(),H.reset()});H&&H.addEventListener("submit",async e=>{if(e.preventDefault(),!N)return;const t=yn.value.trim(),n=Rn.value.trim(),s=parseInt(wn.value,10),r=he.files?he.files[0]:null;if(!(!t||!n)){$.disabled=!0,$.textContent="Uploading...";try{let o=null;if(r){const i=Date.now(),a=dn(bn,`task_attachments/${i}_${r.name}`),c=await ln(a,r);o=await un(c.ref)}await Qe(pe(te,"dev_task"),{title:t,content:n,priority:s,completed:!1,attachment_url:o,createdAt:et(),createdBy:{uid:N.uid,email:N.email||"Anonymous",name:N.displayName||"Unknown"}}),ne.close(),H.reset()}catch(o){console.error("Error creating task:",o),alert("Failed to create task (Check console for permission details)")}finally{$.disabled=!1,$.textContent="Create Task"}}});
