...
// This file contains all 10 mission scenarios for the mouthpiece feature
...
export const MISSION_SCENARIOS: MissionScenario[] = [
    {
        id: 'lost_item',
        name: {
            en: 'Lost Item Inquiry',
            zh: '失物查詢',
            jp: '紛失物の問い合わせ',
            kr: '분실물 조회',
            es: 'Consulta de objetos perdidos',
            fr: 'Demande d\'objets trouvés',
            it: 'Richiesta oggetti smarriti'
        },
        description: {
    ...
    },
    {
        id: 'business_hours',
        name: {
            en: 'Business Hours Confirmation',
            zh: '營業確認',
            jp: '営業時間の確認',
            kr: '영업시간 확인',
            es: 'Confirmación de horario comercial',
            fr: 'Confirmation des heures d\'ouverture',
            it: 'Conferma orari di apertura'
        },
        description: {
    ...
    },
    {
        ...
        description: {
            ...
            jp: '招待者に電話してイベントへの出席を確認し、参加人数と特別な食事要件を確認する。',
    ...
    },
    {
        ...
        name: {
            en: 'Repair Appointment',
            zh: '報修預約',
            jp: '修理予約',
            kr: '수리 예약',
            es: 'Cita de reparación',
            fr: 'Rendez-vous de réparation',
            it: 'Appuntamento riparazione'
        },
        description: {
    ...
    },
    {
        ...
        name: {
            en: 'Order Modification',
            zh: '訂單修改',
            jp: '注文変更',
            kr: '주문 변경',
            es: 'Modificación de pedido',
            fr: 'Modification de commande',
            it: 'Modifica ordine'
        },
        description: {
            ...
            jp: '顧客に代わって販売者に電話し、製品仕様、数量、配送情報の変更を依頼する。',
            ...
            fr: 'Appeler un commerçant au nom d\'un client pour demander des modifications des spécifications du produit, de la quantité ou des informations de livraison.',
    ...
    },
    {
        ...
        name: {
            ...
            jp: '緊急通知',
            kr: '긴급 알림',
            es: 'Notificación de emergencia',
            fr: 'Notification d\'urgence',
            it: 'Notifica di emergenza'
        },
        description: {
    ...
    },
    {
        ...
        name: {
            en: 'Schedule Verification',
            zh: '行程核對',
            jp: 'スケジュール確認',
            kr: '일정 확인',
            es: 'Verificación de horario',
            fr: 'Vérification d\'horaire',
            it: 'Verifica programma'
        },
        description: {
            ...
            jp: 'ビジネス連絡先に電話して、会議または面接の具体的な時間、場所、必要書類を確認する。',
