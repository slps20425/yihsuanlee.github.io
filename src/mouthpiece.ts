        ...
        if (localSession) {
            try {
                ...
                if (sessionData.isGuest || sessionData.isAdmin) {
                    console.log('[Mouthpiece] Guest/Admin session detected, allowing access');
                    ...
                    // For admin/guest, still need to load missions and initialize the page
                    dynamicMissions = await fetchMissionsFromFirestore();
                    console.log(`Loaded ${dynamicMissions.length} missions from Firestore`);
                    populateMissionDropdown();
                    updateMissionDescription();
                ...
                console.error('[Mouthpiece] Error parsing session:', e);
            }
        }
